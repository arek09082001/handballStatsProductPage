...
interface BoardCtaProps {
  ...
  title: string;
  description: string;
  /** Label of the solid orange action; always points at the live demo. */
  primaryLabel?: string;
  /** Secondary, chalk-ghost action — the newsletter / launch offer by default. */
  secondaryHref?: string;
  secondaryLabel?: string;
}

/**
 * The closing CTA band shared by the commercial pages — the landing page's
 * final-CTA language: a court signature band with the court chalked behind, the
 * coach's marker kicker, one solid orange action to the no-account live demo
 * and a chalk-ghost secondary. Static server component (plain anchors/links).
...
export default function BoardCta({
  ...
  title,
  description,
  primaryLabel = 'Live-Demo starten',
