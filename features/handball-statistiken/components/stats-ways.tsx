...
import { STAT_WAY_LINKS, type StatWayCopy } from '../data/stats-content';
...
export default function StatsWays() {
  const t = useTranslations('statsPage.ways');
  const ways = t.raw('items') as StatWayCopy[];
    ...
    <section
      ...
      <div className='relative mx-auto max-w-6xl px-6 sm:px-10'>
        ...
        <div className='mt-12 grid gap-6 md:grid-cols-3'>
          {ways.map((way, index) => {
            const href = STAT_WAY_LINKS[index];
