...
export const handballStatistikZettelExcelApp: Article = {
  slug: 'handball-statistik-zettel-excel-app',
  ...
  keywords: [
    ...
    'handball statistik zettel',
    'handball statistik führen vergleich',
    'handball statistik software',
    'handball spielbogen',
    'handball statistik tool',
  ],
  ...
  imageAlt: 'Live-Erfassung von Spielereignissen in der Statix Handball-App',
  body: `Fast jeder Statistikversuch im Amateurhandball scheitert am selben Punkt: Das Werkzeug passt nicht zu der Person, die am Spielfeldrand sitzt. Ein perfekt gebauter Erfassungsbogen nützt nichts, wenn ihn niemand ausfüllt, und die beste App nützt nichts, wenn niemand ein Tablet mitbringt.
...
5. **Halte zehn Spiele durch, bevor du das Werkzeug wechselst.** Der häufigste Fehler ist nicht die falsche Wahl, sondern der Wechsel nach vier Spielen – und danach fängt niemand ein drittes Mal an.`,
  modules: [
    {
      after: 'Die drei Optionen im Vergleich',
      kind: 'decisionMatrix',
      caption: 'Was jede Option leistet',
      criteria: [
        'Aufwand im Spiel',
        'Aufwand danach',
        'Vergleichbarkeit',
      ...
      options: [
        {
          ...
          scores: ['geht', 'schlecht', 'geht', 'gut', 'gut'],
          verdict: 'Richtig, wenn du allein auf der Bank sitzt – dann aber radikal reduziert',
        },
        {
          name: 'Excel-Vorlage',
          scores: ['schlecht', 'geht', 'gut', 'geht', 'gut'],
          verdict: 'Stark für die Auswertung nach dem Spiel, schwach für die Live-Erfassung',
        },
        {
          name: 'Statistik-App',
          scores: ['gut', 'gut', 'gut', 'geht', 'geht'],
          verdict: 'Richtig, sobald eine Person nur erfasst und die Halle offline funktioniert',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'Reicht Excel für die Handball-Statistik?',
      answer:
    ...
    {
      question: 'Was ist der häufigste Fehler beim Einstieg in die Statistik?',
      answer:
    ...
    {
      question: 'Muss eine Handball-Statistik-App offline funktionieren?',
      answer:
    ...
    {
      question: 'Wie erfasse ich Statistik, wenn ich allein auf der Bank sitze?',
      answer:
