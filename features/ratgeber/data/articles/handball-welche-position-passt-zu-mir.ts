...
export const handballWelchePositionPasstZuMir: Article = {
  slug: 'handball-welche-position-passt-zu-mir',
  title: 'Welche Handball-Position passt zu mir? So findest du deine Rolle',
  metaTitle: 'Welche Handball-Position passt zu mir?',
  metaDescription:
    'Welche Handball-Position passt zu dir? Stärkenprofil, Körperbau und Spielertyp im Check: von Torwart über Außen und Rückraum bis Kreisläufer – mit Selbsttest.',
  keywords: [
    'welche position handball',
    'handball position finden',
    'handball position test',
    'spielertyp handball',
    'handball positionen anforderungen',
...
| Position | Typische Stärken | Spielertyp |
| --- | --- | --- |
| Torwart | Reaktion, Mut, Nervenstärke | der Unerschütterliche |
| Außen (links/rechts) | Schnelligkeit, Sprungkraft, Wurfvarianten | der Sprinter |
| Rückraum halb | Wurfkraft, Größe, 1 gegen 1 | der Vollstrecker |
| Rückraum Mitte | Übersicht, Passqualität, Spielintelligenz | der Stratege |
| Kreisläufer | Kraft, Robustheit, Ballgefühl auf engem Raum | der Kämpfer |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Tore, Würfe und Fehler live per Tap und siehst pro Spieler, aus welchen Positionen und Situationen er erfolgreich ist. So wird aus „Ich glaube, er ist ein Außen" ein belegbares „Seine Quote von außen ist top". Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Auf welcher Position spielen Linkshänder im Handball?',
      answer:
    ...
    {
      question: 'Muss man groß sein, um im Rückraum zu spielen?',
      answer:
    ...
    {
      question: 'Sollten Kinder früh auf eine Position festgelegt werden?',
      answer:
