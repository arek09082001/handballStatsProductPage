...
export const handballAbwehrsystemAuswaehlen: Article = {
  slug: 'handball-abwehrsystem-auswaehlen',
  ...
  keywords: [
    ...
    'handball 6 0 oder 5 1',
    'abwehrsystem jugend handball',
    'handball abwehr umstellen',
    'handball abwehrsystem vergleich',
    'handball defensive wählen',
  ],
...
Bewertet wird, wie gut jedes System mit der jeweiligen Voraussetzung zurechtkommt. Hintergrund zu jedem System findest du in den ausführlichen Artikeln zur [6:0](/ratgeber/handball-6-0-abwehr), [5:1](/ratgeber/handball-5-1-abwehr), [3:2:1](/ratgeber/handball-3-2-1-abwehr) und [Manndeckung](/ratgeber/handball-manndeckung).
...
1. **Wo fallen eure Gegentore?** Notiere jedes Gegentor mit Zone: Rückraum neun Meter, Durchbruch, Kreis, Außen, Gegenstoß. Wenn über die Hälfte aus dem Rückraum fällt, hast du ein Druck- oder Blockproblem; fallen sie am Kreis, ein Zuordnungsproblem. Beide führen zu unterschiedlichen Antworten – und nur eine davon ist ein Systemwechsel.
2. **Wie viele Zeitstrafen bekommt ihr?** Über vier pro Spiel deutet fast immer darauf hin, dass eure Verteidiger zu spät am Gegenspieler sind. Ein offensiveres System verschärft das.
3. **Wie viele Gegentore fallen nach eigenem Ballverlust?** Wenn diese Zahl hoch ist, liegt euer Problem im Angriff und im Rückzug – nicht in der Abwehrordnung.

Und wenn du umstellst: Plan drei Einheiten ein, nicht eine. Erst die Ordnung ohne Ball, dann die Bewegung gegen halbaktive Angreifer, dann die Entscheidung gegen aktive. Wie das im Detail abläuft, steht in der [Übersicht der Abwehrsysteme](/ratgeber/handball-abwehrsysteme).`,
  modules: [
    {
      after: 'Fünf Mannschaftstypen, für die du entscheidest',
      kind: 'formation',
      system: '5-1',
      caption:
        'Die 5:1 als Zwischenschritt: Sie unterscheidet sich von der 6:0 nur in einer Position – der Vorgezogene kommt aus dem Innenblock heraus. Genau das macht sie zur einzigen Zweitordnung, die im Amateurbereich zuverlässig funktioniert.',
    },
    {
      after: 'Die Systeme im Vergleich',
      kind: 'decisionMatrix',
      caption: 'Was jedes System voraussetzt',
      criteria: [
        'Wenig Trainingszeit',
        'Kleine, bewegliche Mannschaft',
        'Große, langsame Mannschaft',
        'Ausbildungswert im Nachwuchs',
      ],
      options: [
        {
          name: '6:0',
          scores: ['gut', 'schlecht', 'gut', 'schlecht'],
          verdict: 'Das Grundsystem: schnell zu vermitteln, verzeiht wenig Beweglichkeit',
        },
        {
          name: '5:1',
          scores: ['geht', 'gut', 'geht', 'geht'],
          verdict: 'Der beste Zweitsystem-Kandidat, weil nur eine Position abweicht',
        },
        {
          name: '3:2:1',
          scores: ['schlecht', 'gut', 'schlecht', 'gut'],
          verdict: 'Hoher Ertrag, hoher Preis – braucht Trainingszeit und Beinarbeit',
        },
        {
          name: 'Manndeckung',
          scores: ['geht', 'gut', 'schlecht', 'gut'],
          verdict: 'Als Phasenmittel und im Nachwuchs wertvoll, als Dauerlösung zu teuer',
        },
      ],
    },
  ],
  faqs: [
    ...
    {
      question: 'Welches Abwehrsystem sollten Jugendmannschaften spielen?',
      answer:
    ...
    {
      question: 'Wann lohnt sich der Wechsel von 6:0 auf 5:1?',
      answer:
    ...
    {
      question: 'Wie viele Einheiten braucht eine Systemumstellung?',
      answer:
    ...
    {
      question: 'Sollte man das Abwehrsystem an den Gegner anpassen?',
      answer:
