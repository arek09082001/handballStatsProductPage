...
export const handballSprungkraftVerbessern: Article = {
  slug: 'handball-sprungkraft-verbessern',
  title: 'Sprungkraft im Handball verbessern: Übungen für höhere Sprungwürfe',
  metaTitle: 'Sprungkraft im Handball verbessern: Übungen & Plan',
  metaDescription:
    'Sprungkraft im Handball verbessern: Übungen, Plyometrie und Technik für höhere Sprungwürfe. So springst du am Kreis und im Rückraum höher und wirfst gefährlicher.',
  keywords: [
    'sprungkraft handball',
    'sprungkraft verbessern handball',
    'plyometrie handball',
    'höher springen handball',
    'sprungwurf höhe',
    'sprungkraft übungen',
...
| Übung | Ziel | Hinweis |
| --- | --- | --- |
| Kastensprünge | explosiver beidbeiniger Absprung | weich und kontrolliert landen |
| Tiefsprünge (Drop Jumps) | reaktive Sprungkraft | erst mit Erfahrung, niedrige Kastenhöhe |
| Einbeinige Sprünge | handballnahe Absprungkraft | beide Beine gleich trainieren |
| Hürdensprünge | Schnelligkeit im Absprung | kurze Bodenkontaktzeiten anstreben |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Wurfquoten und Abschlüsse je Position live per Tap. So siehst du, ob deine Rückraum- und Außenspieler nach dem Sprungkrafttraining tatsächlich häufiger und sauberer treffen. Zahlen statt Bauchgefühl – teste es kostenlos und ohne Account in der Live-Demo unter demo.handballwebseite.de.`,
  faqs: [
    ...
    {
      question: 'Was ist Plyometrie im Handball?',
      answer:
    ...
    {
      question: 'Wie oft sollte man Sprungkrafttraining machen?',
      answer:
    ...
    {
      question: 'Springt man im Handball ein- oder beidbeinig ab?',
      answer:
