...
export const handballAufwaermenUebungen: Article = {
  slug: 'handball-aufwaermen-uebungen',
  title: 'Aufwärmen im Handball: die besten Übungen für Training & Spiel',
  metaTitle: 'Aufwärmen im Handball: Übungen & Aufwärmprogramm',
  metaDescription:
    'Aufwärmen im Handball: die besten Aufwärmübungen für Training und Spiel, der Ablauf in drei Phasen, ein 15-Minuten-Programm und Tipps zur Verletzungsprävention.',
  keywords: [
    'handball aufwärmen',
    'handball aufwärmübungen',
    'handball warm up',
    'aufwärmen vor dem spiel handball',
    'handball aufwärmprogramm',
...
Wer diese Fehler vermeidet, hat schon viel gewonnen: Das Team ist ab der ersten Sekunde da – wach, beweglich und geschützt. Wie du darüber hinaus gezielt [Verletzungen vorbeugst](/ratgeber/handball-verletzungen-vorbeugen), liest du hier. Wenn du festhalten willst, wie einsatzbereit deine Mannschaft startet, kannst du Trainingsfleiß und Spieldaten mit der [kostenlosen Handball-Statistik-App](/handball-statistik-app-kostenlos) Statix dokumentieren – eine kostenlose Live-Demo ohne Account findest du unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Sollte man sich vor dem Handballspiel statisch dehnen?',
      answer:
    ...
    {
      question: 'Welche Aufwärmübungen sind im Handball am wichtigsten?',
      answer:
    ...
    {
      question: 'Wie beugt man mit dem Aufwärmen Verletzungen vor?',
      answer:
