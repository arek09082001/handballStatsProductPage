...
export const handballFreilaufenOhneBall: Article = {
  ...
  keywords: [
    'freilaufen handball',
    'spiel ohne ball handball',
    'laufwege handball',
    'anbieten handball',
    'timing angriff handball',
...
| Auslaufen nach außen | Breite herstellen, Abwehr auseinanderziehen |
| Stoßen in die Lücke | den Raum zwischen zwei Verteidigern angreifen |
| Kreuzen | Verteidiger durch Überkreuzen der Laufwege binden |
| Nachstoßen nach Pass | nach dem Abspiel sofort wieder anbieten |
...
Gutes Freilaufen zeigt sich in flüssigem Ballfluss, wenigen technischen Fehlern und hochwertigen Abschlüssen. Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du technische Fehler und Wurfpositionen live und erkennst, ob euer Angriff durch besseres Bewegen ohne Ball flüssiger und gefährlicher wird. So wird aus einer schwer greifbaren Fähigkeit ein messbarer Fortschritt. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Warum ist das Spiel ohne Ball so wichtig?',
      answer:
    ...
    {
      question: 'Was ist beim Freilaufen wichtiger – Tempo oder Timing?',
      answer:
    ...
    {
      question: 'Wie trainiert man Freilaufen?',
      answer:
