...
export const handballWurftrainingSprungwurf: Article = {
  ...
  title: 'Wurftraining im Handball: Sprungwurf und Wurfkraft verbessern',
  metaTitle: 'Wurftraining Handball: Sprungwurf & Wurfkraft',
  metaDescription:
    'Wurftraining im Handball: So verbesserst du Sprungwurf, Wurftechnik und Wurfkraft – mit klarer Anleitung, typischen Fehlern und starken Übungen für die Halle.',
  keywords: [
    'wurftraining handball',
    'sprungwurf handball',
    'wurfkraft handball verbessern',
...
Genau dafür ist **Statix** gemacht: die Handball-Statistik-App, mit der du jeden Wurf live per Tap erfasst – auch offline in der Halle. Wurfquoten und Wurfbilder entstehen automatisch und zeigen dir schwarz auf weiß, ob das Techniktraining ankommt. Ausprobieren kannst du das ohne Anmeldung in der kostenlosen Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Wie verbessere ich meine Wurfkraft im Handball?',
      answer:
