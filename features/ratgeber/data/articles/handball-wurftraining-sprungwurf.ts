...
export const handballWurftrainingSprungwurf: Article = {
  slug: 'handball-wurftraining-sprungwurf',
  ...
  modules: [
    {
      ...
      caption: '90 Minuten mit Wurfschwerpunkt',
      blocks: [
        {
          minutes: 12,
          label: 'Aufwärmen mit Wurfvorbereitung',
          note: 'Schulter mobilisieren, lockere Zuspiele mit steigender Distanz.',
        },
        {
          minutes: 15,
          label: 'Rhythmus ohne Tor',
          note: 'Übung 1 – Dreierrhythmus und Stemmschritt, ohne Wurf aufs Tor.',
        },
        {
          minutes: 18,
          label: 'Grundwurf mit Torwart',
          note: 'Übung 2 und 3 – Schlagwurf und Sprungwurf, Technikfokus.',
        },
        {
          minutes: 20,
          label: 'Wurf unter Bedingung',
          note: 'Übung 4 und 5 – gegen Block, aus dem Anlauf, mit Zeitdruck.',
        },
        {
          minutes: 20,
          label: 'Abschluss aus der Spielform',
          note: 'Übung 6 – Entscheidung statt Wiederholung.',
        },
        { minutes: 5, label: 'Ausklang', note: 'Schulter locker ausbewegen.' },
      ],
    },
    {
      after: 'Sechs Übungen für den Wurfaufbau',
      kind: 'exercise',
      name: '1 · Dreierrhythmus ohne Tor',
      meta: '15 Min. · ab D-Jugend',
      setup:
      ...
      commonError:
        'Der Stemmschritt ist zu kurz. Ohne Bremse gibt es keine Rotation, also weder Härte noch Kontrolle über die Ecke.',
      variation: 'Beidseitig durchführen – auch Rechtshänder gehen zwei Durchgänge über die andere Seite.',
    },
    {
      after: 'Sechs Übungen für den Wurfaufbau',
      kind: 'exercise',
      name: '2 · Schlagwurf aus dem Stand',
      meta: '9 Min. · ab E-Jugend',
      setup:
      ...
      commonError:
        'Der Ellenbogen sinkt ab. Das kostet Härte und ist der Dauerbegleiter von Schulterbeschwerden im Handball.',
    },
    {
      after: 'Sechs Übungen für den Wurfaufbau',
      kind: 'exercise',
      name: '3 · Sprungwurf aus dem Anlauf',
      meta: '9 Min. · ab D-Jugend',
      setup:
      ...
      commonError:
        'Beidbeiniger Absprung. Er kostet Höhe, Winkel und Weite gleichzeitig und ist meist ein Rhythmusproblem, kein Sprungkraftproblem.',
      variation: 'Absprung nach einem Richtungswechsel – näher an der Spielsituation.',
    },
    {
      after: 'Sechs Übungen für den Wurfaufbau',
      kind: 'exercise',
      name: '4 · Wurf gegen Block',
      ...
      commonError:
        'Der Werfer entscheidet erst in der Luft. Der Wurf wird dadurch verzögert und der Block hat Zeit.',
    },
    {
      after: 'Sechs Übungen für den Wurfaufbau',
      kind: 'exercise',
      name: '5 · Ecke auf Ansage',
      meta: '10 Min. · ab C-Jugend',
      setup:
      ...
      commonError:
        'Der Werfer verändert den gesamten Ablauf, um die Ecke zu erreichen. Für den Torwart ist das lesbar, bevor der Ball fliegt.',
      variation:
        'Die Ansage kommt erst im Sprung – das trainiert die späte Entscheidung, die im Spiel den Unterschied macht.',
    },
    {
      after: 'Sechs Übungen für den Wurfaufbau',
      kind: 'exercise',
      name: '6 · Abschluss aus der Spielform',
      ...
      commonError:
        'Es wird geworfen, sobald der Ball da ist. Die Zonenzählung am Ende macht das sichtbar, ohne dass du es rufen musst.',
    },
  ],
  faqs: [
    {
    ...
    {
      question: 'Wie verbessere ich die Wurfkraft meiner Spieler?',
      answer:
    ...
    {
      question: 'Wie viele Würfe pro Trainingseinheit sind sinnvoll?',
      answer:
    ...
    {
      question: 'Welche Wurfarten sollte ein Spieler zuerst lernen?',
      answer:
