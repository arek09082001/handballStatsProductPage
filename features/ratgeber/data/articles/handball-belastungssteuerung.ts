...
export const handballBelastungssteuerung: Article = {
  slug: 'handball-belastungssteuerung',
  ...
  keywords: [
    ...
    'handball trainingswoche planen',
    'handball überlastung erkennen',
    'handball spieltag vorbereitung',
    'handball belastung jugend',
    'handball erholung training',
  ],
  ...
  imageAlt: 'Wochen- und Saisonübersicht einer Handballmannschaft in der Statix-App',
  body: `In fast jeder Amateurmannschaft sehen alle Trainingseinheiten gleich aus: 90 Minuten, mittlere Intensität, dienstags wie donnerstags. Das ist bequem zu planen und der Hauptgrund dafür, dass Mannschaften am Samstag müde sind und trotzdem nicht besser werden. Anpassung entsteht aus dem **Wechsel** von Belastung und Erholung, nicht aus dem Durchschnitt.
...
Wenn du Spielwerte ohnehin erfasst, lässt sich der Vergleich zwischen Schlussphase und Gesamtspiel ohne Zusatzaufwand auswerten – die Zahlen dafür hast du bereits.`,
  modules: [
    {
      after: 'Die Woche um den Spieltag',
      kind: 'sessionTimeline',
      caption: 'Eine Woche mit Spiel am Samstag',
      blocks: [
        {
          minutes: 0,
          label: 'Sonntag – frei',
          note: 'Kein organisiertes Training. Bewegung ja, Belastung nein.',
        },
        {
          minutes: 90,
          label: 'Dienstag – die harte Einheit',
          note: 'Höchste Intensität der Woche: Athletik, Spielformen, Zweikampf. Größter Abstand zum Spiel.',
        },
        {
          minutes: 90,
          label: 'Donnerstag – mittlere Einheit',
          note: 'Taktik, Systeme, technische Schwerpunkte. Intensiv, aber ohne Erschöpfung.',
        },
        {
          minutes: 60,
          label: 'Freitag – kurz und technisch',
          note: 'Wenn überhaupt: Wurf, Standards, Absprachen. Nichts Neues, nichts Ermüdendes.',
        },
        {
          minutes: 60,
          label: 'Samstag – Spiel',
          note: 'Aufwärmen mit bekannten Formen, keine neuen Bewegungsaufgaben.',
        },
      ],
    },
    {
      after: 'Fünf Werkzeuge für die Steuerung',
      kind: 'exercise',
      name: '1 · Eine harte Einheit pro Woche',
      meta: 'wöchentlich · alle Altersstufen',
      setup:
      ...
      commonError:
        'Alle Einheiten werden mittelhart, weil sich niemand traut, eine leicht zu machen. Ergebnis: dauerhaft müde Mannschaft ohne Anpassung.',
    },
    {
      after: 'Fünf Werkzeuge für die Steuerung',
      kind: 'exercise',
      name: '2 · Die Frischeabfrage',
      meta: '1 Min. je Training · ab C-Jugend',
      setup:
      ...
      commonError:
        'Der Trainer reagiert auf niedrige Werte mit Nachfragen vor der Gruppe. Danach sagen alle sieben.',
    },
    {
      after: 'Fünf Werkzeuge für die Steuerung',
      kind: 'exercise',
      name: '3 · Die 48-Stunden-Regel',
      meta: 'wöchentlich · alle Altersstufen',
      setup:
      ...
      commonError:
        'Am Freitag wird noch schnell das Abwehrsystem umgestellt, weil der Gegner es erfordert. Besser: eine bekannte Variante wählen und sie sauber spielen.',
    },
    {
      after: 'Fünf Werkzeuge für die Steuerung',
      kind: 'exercise',
      name: '4 · Die Entlastungswoche',
      meta: 'alle 4–6 Wochen · ab B-Jugend',
      setup:
      ...
      commonError:
        'Die Entlastungswoche wird gestrichen, weil das nächste Spiel wichtig ist. Genau dann wäre sie am wertvollsten.',
    },
    {
      after: 'Fünf Werkzeuge für die Steuerung',
      kind: 'exercise',
      name: '5 · Rückkehr nach einer Pause',
      meta: 'nach Bedarf · alle Altersstufen',
      setup:
      ...
      commonError:
        'Der Spieler kehrt direkt ins Spiel zurück, weil er gebraucht wird. Das ist die häufigste Ursache für die zweite Verletzung.',
    },
  ],
  faqs: [
    {
      question: 'Wie plane ich die Trainingswoche um den Spieltag?',
      answer:
    ...
    {
      question: 'Woran erkenne ich, dass ein Spieler zu viel hat?',
      answer:
    ...
    {
      question: 'Wie viele Ruhetage braucht eine Handballmannschaft?',
      answer:
    ...
    {
      question: 'Was kann ich als Trainer zum Thema Ernährung beitragen?',
      answer:
    ...
    {
      question: 'Wie kehrt ein Spieler nach einer Verletzungspause zurück?',
      answer:
