...
export const handballRegelnEinfachErklaert: Article = {
  slug: 'handball-regeln-einfach-erklaert',
  ...
  keywords: [
    ...
    'handball schritte regel',
    'handball torraum regel',
    'handball zeitstrafe',
    'handball regeln anfänger',
    'handball quereinsteiger erwachsene',
    'schiedsrichterzeichen handball',
  ],
  ...
  imageAlt: 'Handballspiel in der Halle mit Schiedsrichter und Spielern',
  body: `Handball ist schnell erklärt: Zwei Mannschaften mit je sechs Feldspielern und einem Torwart versuchen, den Ball ins gegnerische Tor zu werfen. Wer mehr Tore hat, gewinnt. Die Regeln, die im Spiel tatsächlich für Diskussionen sorgen, sind eine überschaubare Handvoll – und die stehen hier.
...
Gespielt wird auf einem Feld von 40 × 20 Metern. Die beiden Linien, die alles bestimmen, sind die **Torraumlinie bei sechs Metern** – dort darf nur der Torwart stehen – und die **gestrichelte Freiwurflinie bei neun Metern**. Alle Maße im Detail stehen in der Übersicht zu den [Handball-Spielfeldmaßen](/ratgeber/handball-spielfeld-masse).
...
Wenn die angreifende Mannschaft erkennbar keinen Torerfolg anstrebt. Nach dem Vorwarnzeichen dürfen noch bis zu sechs Pässe gespielt werden, danach folgt Freiwurf für den Gegner. Details dazu stehen im Artikel zum [passiven Spiel](/ratgeber/handball-passives-spiel).

**Nach welcher Zeit gilt eine Zeitstrafe als abgelaufen?**
Nach zwei Minuten reiner Spielzeit. Die Mannschaft spielt in dieser Zeit in Unterzahl. Die dritte Zeitstrafe desselben Spielers führt zur Disqualifikation. Mehr dazu unter [Zeitstrafen und progressive Bestrafung](/ratgeber/handball-zeitstrafe-regeln).
...
**Die Reklamation vom Spielfeldrand kostet mehr, als sie bringt.** Die Regeln, über die am häufigsten diskutiert wird – Fuß, Vorteil, Torraumvergehen – sind fast immer Ermessensentscheidungen. Eine Diskussion ändert die Entscheidung nicht und erzeugt bei der zweiten Wiederholung eine Zeitstrafe gegen dich.`,
  modules: [
    {
      kind: 'answerBox',
      text: 'Handball spielen zwei Mannschaften mit je sechs Feldspielern und einem Torwart auf einem Feld von 40 × 20 Metern, zweimal 30 Minuten. Ein Spieler darf drei Schritte gehen und den Ball drei Sekunden halten; der Torraum bei sechs Metern gehört allein dem Torwart. Fouls werden mit Freiwurf, Siebenmeter oder Zeitstrafe geahndet.',
    },
    {
      after: 'Die Regeln, die im Spiel zählen',
      kind: 'benchmarkTable',
      caption: 'Die Regeln auf einen Blick',
      columns: ['Regel', 'Was gilt', 'Bei Verstoß'],
      rows: [
      ...
      note: 'Zusammenfassung für den Trainerbedarf. Verbindlich sind die offiziellen Regeln des Internationalen Handballverbandes in der jeweils aktuellen Fassung und die Durchführungsbestimmungen deines Landesverbandes.',
    },
  ],
  faqs: [
    {
    ...
    {
      question: 'Wie lange dauert ein Handballspiel?',
      answer:
    ...
    {
      question: 'Wer darf in den Torraum im Handball?',
      answer:
    ...
    {
      question: 'Was bedeutet eine Zeitstrafe im Handball?',
      answer:
    ...
    {
      question: 'Was muss ein erwachsener Quereinsteiger zuerst lernen?',
      answer:
    ...
    {
      question: 'Zählt ein Tor, wenn der Werfer gefoult wurde?',
      answer:
  ...
  relatedSlugs: [
    ...
    'handball-ausruestung-einsteiger',
