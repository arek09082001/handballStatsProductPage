...
export const handballRegelnEinfachErklaert: Article = {
  ...
  metaTitle: 'Handball-Regeln einfach erklärt: die wichtigsten Basics',
  metaDescription:
    'Handball-Regeln einfach erklärt: Spielzeit, Schritte, Torraum, Abwehr und Strafen – die wichtigsten Basics für Einsteiger verständlich zusammengefasst.',
  keywords: [
    'handball regeln',
    'handball regeln einfach erklärt',
    'handball regeln für anfänger',
    'schrittfehler handball',
    'handball spielzeit',
    'handball strafen',
    'handball torraum',
    'zeitstrafe handball',
...
| Strafe | Bedeutung |
| --- | --- |
| Freiwurf | Ballbesitz für den Gegner nach einem kleineren Regelverstoß. |
| Siebenmeter | Strafwurf, wenn eine klare Torchance regelwidrig verhindert wird. |
| Gelbe Karte | Verwarnung für ein Foul – die erste Stufe der Bestrafung. |
| 2-Minuten-Zeitstrafe | Der Spieler muss zwei Minuten vom Feld, sein Team spielt in Unterzahl. |
| Rote Karte | Disqualifikation: Der Spieler ist für den Rest des Spiels draußen. |
...
Wenn du als Trainer den Überblick behalten willst, hilft es, nicht nur Tore, sondern auch Strafen, Zeitstrafen und Fairness mitzuerfassen. Eine [Statistik-App für Handballtrainer](/) wie Statix macht das nebenbei mit einem Tap – so siehst du nach dem Spiel schwarz auf weiß, wo dein Team unnötige Zeitstrafen kassiert und Überzahl verschenkt. Welche Strafe wann greift, erklärt der Ratgeber zu [Zeitstrafe und Karten](/ratgeber/handball-zeitstrafe-regeln). Du willst es ausprobieren? Unter [demo.statix-app.de](https://demo.statix-app.de) gibt es eine kostenlose Live-Demo ganz ohne Account.`,
  faqs: [
    {
