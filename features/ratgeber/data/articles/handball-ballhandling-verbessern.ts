...
export const handballBallhandlingVerbessern: Article = {
  ...
  title: 'Ballhandling im Handball verbessern: Ballgefühl, Fangen und Prellen',
  metaTitle: 'Ballhandling im Handball verbessern: Übungen',
  metaDescription:
    'Ballhandling im Handball verbessern: Ballgefühl, sicheres Fangen, Prellen und Passspiel trainieren. Mit einfachen Übungen für Einsteiger und Fortgeschrittene.',
  keywords: [
    'ballhandling handball',
    'ballgefühl handball',
    'fangen handball üben',
    'prellen handball',
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du technische Fehler und Ballverluste live per Tap und siehst über die Saison, ob dein Team sicherer mit dem Ball umgeht. Gerade im Nachwuchs ist die Entwicklung der Fehlerzahl ein guter Gradmesser für die technische Ausbildung. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    ...
    {
      question: 'Wie fängt man einen Handball richtig?',
      answer:
