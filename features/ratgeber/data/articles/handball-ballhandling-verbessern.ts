...
export const handballBallhandlingVerbessern: Article = {
  slug: 'handball-ballhandling-verbessern',
  ...
  keywords: [
    ...
    'handball fangen üben',
    'handball prellen übungen',
    'ballhandling training kinder',
    'handball technik training',
    'ballsicherheit handball',
  ],
  ...
  imageAlt: 'Trainer wertet die technischen Fehler seiner Mannschaft in der Statix-App aus',
  body: `Wenn deine Mannschaft in der Halle sicher aussieht und im Spiel Bälle verliert, liegt es fast nie an der Wurftechnik. Es liegt daran, dass sie den Ball unter Zeitdruck, mit Gegnerkontakt und in der Bewegung nicht sauber verarbeitet. Ballhandling ist die Grundlage, auf der Passspiel, Wurf und Zweikampf stehen – und die einzige Technik, deren Schwäche sich in jeder anderen zeigt.
  ...
  modules: [
    {
      ...
      caption: '90 Minuten mit Ballhandling-Schwerpunkt',
      blocks: [
        {
          minutes: 12,
          label: 'Einlaufen mit Ball',
          note: 'Jeder Spieler ein Ball, freies Laufen mit wechselnden Aufgaben. Kein Warten, keine Reihe.',
        },
        {
          minutes: 15,
          label: 'Ballgewöhnung beidhändig',
          note: 'Übung 1 und 2, ohne Gegner, mit hoher Kontaktzahl.',
        },
        {
          minutes: 20,
          label: 'Verarbeitung in Bewegung',
          note: 'Übung 3 und 4 – Fangen und Weiterspielen im Lauf, Blick weg vom Ball.',
        },
        {
          minutes: 18,
          label: 'Ballschutz unter Druck',
          note: 'Übung 5, mit halbaktivem und dann aktivem Verteidiger.',
        },
        {
          minutes: 20,
          label: 'Spielform mit Fehlerzählung',
          note: '4 gegen 4 auf zwei Tore, jeder Ballverlust wird laut mitgezählt.',
        },
        { minutes: 5, label: 'Abschluss und Rückmeldung', note: 'Zwei Sätze zum Fehlerbild des Tages.' },
      ],
    },
    {
      after: 'Fünf Übungen mit Coaching-Punkten',
      kind: 'exercise',
      name: '1 · Zwei Bälle, zwei Aufgaben',
      meta: '6–8 Min. · ab D-Jugend',
      setup:
      ...
      commonError:
        'Der Kopf senkt sich beim Prellball. Erkennbar daran, dass der Druckpass des Partners plötzlich nicht mehr gefangen wird.',
      variation:
        'Ein dritter Spieler steht seitlich und zeigt Zahlen mit den Fingern, die laut genannt werden müssen – so ist Blickabwendung erzwungen statt nur gefordert.',
    },
    {
      after: 'Fünf Übungen mit Coaching-Punkten',
      kind: 'exercise',
      name: '2 · Handwechsel am Hindernis',
      meta: '6 Min. · ab E-Jugend',
      setup:
      ...
      commonError:
        'Der Ball wird beim Wechsel vor den Körper geführt, statt eng am Bein zu bleiben. Im Spiel ist das der Moment, in dem der Verteidiger zugreift.',
      variation:
        'Statt Hütchen stehen halbaktive Verteidiger, die nur eine Hand zum Ball führen dürfen.',
    },
    {
      after: 'Fünf Übungen mit Coaching-Punkten',
      kind: 'exercise',
      name: '3 · Fangen im Lauf mit Richtungswechsel',
      ...
      commonError:
        'Der Spieler bleibt beim Fangen kurz stehen. Das kostet im Spiel den Tempovorteil, den der Pass gerade erzeugt hat.',
      variation:
        'Der Anspieler variiert Höhe und Härte des Passes ohne Ankündigung, inklusive Bodenpass.',
    },
    {
      after: 'Fünf Übungen mit Coaching-Punkten',
      kind: 'exercise',
      name: '4 · Drei gegen drei ohne Prellen',
      meta: '10 Min. · ab C-Jugend',
      setup: 'Feld von etwa 15 × 12 Metern, Tore markiert durch Hütchentore, Prellen ist verboten.',
      organisation:
      ...
      commonError:
        'Die Spieler bleiben stehen und fordern den Ball statt sich anzubieten. Sichtbar daran, dass der Ballführende drei Sekunden ohne Anspielstation dasteht.',
      variation: 'Ein Pass darf nicht zurück zum letzten Passgeber gehen.',
    },
    {
      after: 'Fünf Übungen mit Coaching-Punkten',
      kind: 'exercise',
      name: '5 · Ballschutz im engen Raum',
      ...
      commonError:
        'Der Ball wird bei Kontakt hochgezogen. Das ist der häufigste Auslöser für Schrittfehler und Stürmerfouls im Spiel.',
    },
  ],
  faqs: [
    {
      question: 'Wie verbessert man Ballhandling im Handballtraining?',
      answer:
    ...
    {
      question: 'Wie oft sollte Ballhandling im Training vorkommen?',
      answer:
    ...
    {
      question: 'Woran erkenne ich schlechtes Ballhandling im Spiel?',
      answer:
