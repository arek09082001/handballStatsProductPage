...
export const handballAthletiktraining: Article = {
  slug: 'handball-athletiktraining',
  ...
  keywords: [
    ...
    'krafttraining handball',
    'sprungkraft handball',
    'schnelligkeit handball',
    'beweglichkeit handball',
    'handball athletik trainingswoche',
    'handball kraftausdauer',
  ],
...
Zwei Hinweise zur Auswertung: Erstens vergleichst du jeden Spieler mit sich selbst, nicht mit der Mannschaft – Athletikwerte hängen im Jugendbereich stark vom Entwicklungsstand ab. Zweitens ist die interessanteste Zahl nicht der Testwert, sondern das Spiel: Wenn eure Fehlerquote und eure Gegentore in den letzten zehn Minuten sinken, hat die Athletikarbeit dort gewirkt, wo sie wirken soll.`,
  modules: [
    {
      after: 'Die Athletikeinheit im Ablauf',
      kind: 'sessionTimeline',
      caption: '75 Minuten Athletik, Variante Vorbereitung',
      blocks: [
        {
          minutes: 12,
          label: 'Aufwärmen mit Mobilität',
          note: 'Baustein 1 – Schulter, Hüfte, Sprunggelenk in Bewegung.',
        },
        {
          minutes: 15,
          label: 'Explosivität',
          note: 'Baustein 2 und 3 – Antritt und Sprünge bei frischem Nervensystem.',
        },
        {
          minutes: 20,
          label: 'Kraft mit Körpergewicht',
          note: 'Baustein 4 – hintere Kette, Rumpf, Schulterstabilität.',
        },
        {
          minutes: 18,
          label: 'Wiederholte Belastung',
          note: 'Baustein 5 – Intervalle mit Ball statt Dauerlauf.',
        },
        {
          minutes: 10,
          label: 'Landetechnik und Ausklang',
          note: 'Baustein 6 – bewusst am Ende, mit müden Beinen.',
        },
      ],
    },
    {
      after: 'Sechs Bausteine für die Halle',
      kind: 'exercise',
      name: '1 · Mobilität im Aufwärmen',
      ...
      commonError:
        'Statisches Dehnen als Aufwärmen. Danach fühlt sich der Spieler locker und springt schlechter.',
      variation: 'Mit Ball in der Hand, um Ballkontakte in den Aufwärmteil zu holen.',
    },
    {
      after: 'Sechs Bausteine für die Halle',
      kind: 'exercise',
      name: '2 · Antritt über zehn Meter',
      ...
      commonError:
        'Zu kurze Pausen. Der Block wird dadurch zum Ausdauerreiz und der eigentliche Trainingsinhalt fällt weg.',
      variation:
        'Start auf ein optisches Signal statt auf Kommando – näher an der Spielsituation.',
    },
    {
      after: 'Sechs Bausteine für die Halle',
      kind: 'exercise',
      name: '3 · Sprungserien mit sauberer Landung',
      meta: '7 Min. · ab B-Jugend',
      setup:
      ...
      commonError:
        'Das Knie knickt bei der Landung nach innen. Das ist das Bewegungsmuster, das mit Verletzungen in Verbindung gebracht wird – hier wird es korrigiert, nicht im Spiel.',
      variation: 'In Wachstumsphasen die Höhe reduzieren und die Serienzahl halbieren.',
    },
    {
      after: 'Sechs Bausteine für die Halle',
      kind: 'exercise',
      name: '4 · Kraftzirkel mit Körpergewicht',
      meta: '20 Min. · ab C-Jugend',
      setup:
      ...
      commonError:
        'Alle machen die schwerste Variante. Gib je Station eine leichtere und eine schwerere Version an und lass die Spieler wählen.',
      variation: 'Mit Zusatzgewicht ab B-Jugend, sobald die Körpergewichtsvariante sauber sitzt.',
    },
    {
      after: 'Sechs Bausteine für die Halle',
      kind: 'exercise',
      name: '5 · Intervalle mit Ball statt Dauerlauf',
      meta: '18 Min. · ab C-Jugend',
      setup:
      ...
      commonError:
        'Zu lange Durchgänge. Ab etwa zwei Minuten sinkt die Intensität so weit, dass die Belastung nicht mehr handballspezifisch ist.',
      variation:
        'In der Wettkampfphase auf vier Durchgänge reduzieren und die Pause verlängern.',
    },
    {
      after: 'Sechs Bausteine für die Halle',
      kind: 'exercise',
      name: '6 · Landen unter Ermüdung',
      meta: '10 Min. · ab B-Jugend',
      setup:
      ...
      commonError:
        'Der Trainer coacht den Wurf statt die Landung. Genau deshalb bleibt die Landetechnik in den meisten Mannschaften unbearbeitet.',
    },
    {
      after: 'Wie viel Athletik in eine Trainingswoche passt',
      kind: 'benchmarkTable',
      caption: 'Verteilung nach Saisonphase',
      columns: ['Phase', 'Explosivität', 'Kraft', 'Wiederholte Belastung', 'Mobilität'],
      rows: [
        ['Vorbereitung', '2× pro Woche', '2× pro Woche', '2× pro Woche', 'täglich, ausgelagert'],
        ['Wettkampf, 3 Einheiten', '1× pro Woche', '1× pro Woche', 'über Spielformen', 'täglich, ausgelagert'],
        ['Wettkampf, 2 Einheiten', '1× pro Woche', 'ausgelagert', 'über Spielformen', 'täglich, ausgelagert'],
        ['Spielwoche mit 2 Spielen', 'entfällt', 'entfällt', 'entfällt', 'täglich, ausgelagert'],
        ['Wachstumsphase Jugend', 'reduziert', 'Körpergewicht', 'reduziert', 'täglich, ausgelagert'],
      ],
      note: 'Planungsraster für den Amateurbereich, keine Trainingsvorschrift. Zwischen zwei intensiven Blöcken derselben Art sollten mindestens 48 Stunden liegen.',
    },
  ],
  faqs: [
    {
      question: 'Wie oft sollte eine Handballmannschaft Athletik trainieren?',
      answer:
    ...
    {
      question: 'Ist Dauerlauf im Handball sinnvoll?',
      answer:
    ...
    {
      question: 'Ab welchem Alter ist Krafttraining im Handball sinnvoll?',
      answer:
    ...
    {
      question: 'Was kann ich als Trainer an die Spieler auslagern?',
      answer:
    ...
    {
      question: 'Wie messe ich, ob das Athletiktraining wirkt?',
      answer:
    ...
    {
      question: 'Wie gehe ich mit Wachstumsphasen im Jugendbereich um?',
      answer:
