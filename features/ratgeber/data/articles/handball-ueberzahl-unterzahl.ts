...
export const handballUeberzahlUnterzahl: Article = {
  slug: 'handball-ueberzahl-unterzahl',
  title: 'Überzahl und Unterzahl im Handball: Zeitstrafen clever nutzen und überstehen',
  metaTitle: 'Überzahl & Unterzahl im Handball',
  metaDescription:
    'Über- und Unterzahl im Handball meistern: Wie du eine Überzahl in Tore verwandelst und eine Unterzahl schadlos übersteht – Prinzipien, Aufstellungen und Übungen.',
  keywords: [
    'überzahl handball',
    'unterzahl handball',
    'handball zeitstrafe spielen',
    'überzahlspiel handball',
    'unterzahl abwehr handball',
    '7 gegen 6 handball',
    'powerplay handball',
  ],
...
| Situation | Fokus |
| --- | --- |
| Eigene Überzahl im Angriff | Ball laufen lassen, guten Wurf erspielen |
| Eigene Überzahl in der Abwehr | aggressiver verteidigen, Ballgewinne suchen |
| Eigene Unterzahl im Angriff | Ballsicherheit, Zeit von der Uhr nehmen |
| Eigene Unterzahl in der Abwehr | kompakt, Mitte zu, Schaden begrenzen |
...
Ob eure Mannschaft diese Phasen gewinnt, lässt sich klar messen: Wie viele Tore erzielt und kassiert ihr in Über- und Unterzahl? Mit **Statix**, der Handball-Statistik-App für Trainer, kannst du Spielphasen erfassen und sehen, ob eure Überzahl wirklich Tore bringt und eure Unterzahl standhält. Aus diesem Bild wird ein gezielter Trainingsschwerpunkt für genau die Minuten, die Spiele entscheiden. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
