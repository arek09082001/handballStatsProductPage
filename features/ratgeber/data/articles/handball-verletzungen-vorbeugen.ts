...
export const handballVerletzungenVorbeugen: Article = {
  slug: 'handball-verletzungen-vorbeugen',
  title: 'Verletzungen im Handball vorbeugen: Prävention für Knie, Schulter und Sprunggelenk',
  metaTitle: 'Verletzungen im Handball vorbeugen: Prävention',
  metaDescription:
    'Verletzungen im Handball vorbeugen: Prävention für Knie, Schulter und Sprunggelenk, Aufwärmen und Ausgleichsübungen. So bleibt dein Team die ganze Saison gesund.',
  keywords: [
    'verletzungen handball vorbeugen',
    'verletzungsprävention handball',
    'knieverletzung handball',
    'schulter handball prävention',
    'sprunggelenk handball',
    'handball prävention übungen',
    'verletzungen handball',
  ],
...
| Wackelbrett/Kissen | Stabilisatoren aktivieren |
| Einbeinige Landungen | Kontrolle beim Aufkommen |
| Sprünge mit stabiler Landung | reaktive Stabilität |
...
**Statix**, die Handball-Statistik-App für Trainer, hilft dir, Einsatzzeiten und Belastungen deiner Spieler über die Saison im Blick zu behalten. So siehst du, wer besonders viel auf dem Feld steht, und kannst Belastung und Regeneration bewusster steuern. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Wie beugt man Knieverletzungen im Handball vor?',
      answer:
    ...
    {
      question: 'Wie schützt man die Wurfschulter im Handball?',
      answer:
    ...
    {
      question: 'Kann man Verletzungen im Handball wirklich verhindern?',
      answer:
