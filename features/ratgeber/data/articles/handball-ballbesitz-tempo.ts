...
export const handballBallbesitzTempo: Article = {
  slug: 'handball-ballbesitz-tempo',
  ...
  keywords: [
    ...
    'handball tempo',
    'angriffseffektivität handball',
    'possession handball',
    'handball spieltempo messen',
    'handball angriffe pro spiel',
  ],
...
| Tore nach Gegenstoß | 4 | 9 |
| Angriffseffektivität | **60,9 %** | **44,3 %** |
| Fehlerquote | 13,0 % | 23,0 % |
| Tempoanteil | 14,3 % | 33,3 % |
...
Angriffe zu rechnen kostet dich zwei Zahlen mehr am Spielfeldrand: technische Fehler und Siebenmeter, die Abschlüsse hast du ohnehin. Wer Effektivität und Torfolge lieber live sehen will, erfasst die Ereignisse mit [Statix](/) per Tap und bekommt Angriffe und Effektivität ohne Nachrechnen.`,
  modules: [
    {
      kind: 'answerBox',
      text: 'Ein Ballbesitz endet immer auf eine von drei Arten: mit einem Abschluss, mit einem technischen Fehler oder mit einem Siebenmeter. Die Summe ergibt eure Angriffe. Erst mit dieser Bezugsgröße lassen sich zwei Handballspiele vergleichen – die Torzahl allein sagt nichts über die Qualität eines Angriffsspiels.',
    },
    {
      after: 'So zählst du Ballbesitze, ohne mitzuschreiben',
      kind: 'formula',
      label: 'Angriffe, ohne sie zu strichlisten',
      formula: 'Angriffe = Abschlüsse + technische Fehler + Siebenmeter',
      example:
        '45 Abschlüsse, 12 technische Fehler und 5 Siebenmeter ergeben 62 Angriffe. Mit 28 Toren ist das eine Angriffseffektivität von 45,2 %.',
    },
    {
      after: 'Was normale Werte sind',
      kind: 'benchmarkTable',
      caption: 'Rahmenwerte im Erwachsenen-Amateurbereich',
      columns: ['Kennzahl', 'Üblicher Bereich', 'Was ein Ausreißer bedeutet'],
      rows: [
        ['Angriffe je Mannschaft', '46–60', 'über 62: sehr offenes Spiel, meist mit hoher Fehlerquote'],
        ['Angriffseffektivität', '48–58 %', 'unter 45 %: Abschluss oder Ballsicherheit stimmt nicht'],
        ['Fehlerquote', '12–18 %', 'über 20 %: jeder fünfte Angriff endet ohne Abschluss'],
        ['Tempoanteil an den Toren', '15–25 %', 'über 35 %: der Positionsangriff trägt zu wenig'],
      ],
      note: 'Erfahrungswerte aus dem Erwachsenen-Amateurbereich, keine erhobene Statistik. Im Jugendbereich liegen Angriffszahl und Fehlerquote höher.',
    },
  ],
  faqs: [
    {
    ...
    {
      question: 'Wie berechnet man die Angriffseffektivität?',
      answer:
    ...
    {
      question: 'Wie viel Tempo ist sinnvoll?',
      answer:
    ...
    {
      question: 'Wie viele Angriffe hat eine Handballmannschaft pro Spiel?',
      answer:
