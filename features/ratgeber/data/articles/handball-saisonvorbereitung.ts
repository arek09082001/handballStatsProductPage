...
export const handballSaisonvorbereitung: Article = {
  slug: 'handball-saisonvorbereitung',
  title: 'Handball-Saisonvorbereitung: Trainingsplan & Konditionsaufbau',
  metaTitle: 'Handball-Saisonvorbereitung: Trainingsplan & Kondition',
  metaDescription:
    'Handball-Saisonvorbereitung planen: Phasen, Konditionsaufbau und Beispiel-Wochenplan. So legst du mit der richtigen Vorbereitung das Fundament für die Saison.',
  keywords: [
    'handball saisonvorbereitung',
    'handball vorbereitung trainingsplan',
    'handball kondition aufbauen',
    'handball sommervorbereitung',
    'handball vorbereitung übungen',
    'ausdauer handball',
...
| --- | --- | --- |
| Montag | Regeneration | Frei oder lockere Einheit, Mobilisation |
| Dienstag | Athletik & Ausdauer | Intervalle, Kraft, Stabilisation |
| Mittwoch | Handballspezifisch | Tempospiel, Antritte mit Ball, Torabschluss |
| Donnerstag | Regeneration | Erholung oder lockeres Laufen |
| Freitag | Taktik & Technik | Abwehrformation, Angriffssysteme, Wurf |
| Samstag | Testspiel | Spielpraxis, Automatismen prüfen |
| Sonntag | Frei | Vollständige Erholung |
