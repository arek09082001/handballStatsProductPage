...
export const siebenmeterTrainieren: Article = {
  slug: 'siebenmeter-trainieren',
  ...
  keywords: [
    ...
    '7 meter handball üben',
    'siebenmeterquote handball',
    'handball strafwurf training',
    'siebenmeter schütze auswählen',
    'siebenmeter druck handball',
  ],
  ...
  modules: [
    {
      ...
      caption: '25-Minuten-Block am Ende der Einheit',
      blocks: [
        {
          minutes: 4,
          label: 'Technikdurchgang ohne Torwart',
          note: 'Je fünf Würfe in die vorher genannte Ecke, ruhiger Ablauf.',
        },
        {
          minutes: 6,
          label: 'Übung 1 – feste Routine',
          note: 'Immer derselbe Ablauf, vom Pfiff bis zum Wurf.',
        },
        {
          minutes: 6,
          label: 'Übung 2 – Torwart liest mit',
          note: 'Der Torwart darf laut ansagen, was er gesehen hat.',
        },
        {
          minutes: 5,
          label: 'Übung 3 – mit Konsequenz',
          note: 'Fehlwurf kostet die Mannschaft etwas, Treffer bringt etwas.',
        },
        {
          minutes: 4,
          label: 'Übung 4 – Schlussphase simulieren',
          note: 'Nach Belastung, mit Zuschauergeräusch und Zeitdruck.',
        },
      ],
    },
    {
      after: 'Vier Übungen, die Druck erzeugen',
      kind: 'exercise',
      name: '1 · Die Routine einschleifen',
      ...
      commonError:
        'Der Vorlauf wird unter Druck kürzer oder länger. Der Wurf wird dadurch zu einem anderen Wurf als der trainierte.',
      variation:
        'Der Trainer pfeift verzögert oder überraschend früh – die Routine muss trotzdem gleich bleiben.',
    },
    {
      after: 'Vier Übungen, die Druck erzeugen',
      kind: 'exercise',
      name: '2 · Der Torwart liest laut mit',
      meta: '6 Min. · ab B-Jugend',
      setup: 'Ein Schütze, ein Torwart. Nach jedem Wurf sagt der Torwart, woran er die Ecke erkannt hat.',
      organisation:
      ...
      commonError:
        'Der Schütze versucht, jeden Hinweis gleichzeitig zu unterdrücken, und verliert dabei seine Routine.',
    },
    {
      after: 'Vier Übungen, die Druck erzeugen',
      kind: 'exercise',
      name: '3 · Siebenmeter mit Konsequenz',
      ...
      commonError:
        'Der Schütze wirft härter, um sicherzugehen. Die Fehlwürfe kommen dann mittig statt in die Ecke.',
      variation:
        'Die Konsequenz trifft nur den Schützen selbst – das erzeugt einen anderen, individuelleren Druck.',
    },
    {
      after: 'Vier Übungen, die Druck erzeugen',
      kind: 'exercise',
      name: '4 · Die 58. Minute',
      ...
      commonError:
        'Der Schütze beschleunigt seinen Ablauf, um die Situation schnell hinter sich zu bringen. Genau das ist der Fehler, den diese Übung sichtbar machen soll.',
    },
  ],
  faqs: [
    {
    ...
    {
      question: 'Was ist eine gute Siebenmeterquote im Handball?',
      answer:
    ...
    {
      question: 'Wie viele Siebenmeterschützen braucht eine Mannschaft?',
      answer:
    ...
    {
      question: 'Soll ein Schütze nach einem gehaltenen Siebenmeter die Ecke wechseln?',
      answer:
