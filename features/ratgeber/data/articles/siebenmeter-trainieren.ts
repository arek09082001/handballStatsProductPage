...
export const siebenmeterTrainieren: Article = {
  ...
  title: 'Siebenmeter im Handball trainieren: Technik und Nervenstärke',
  metaTitle: 'Siebenmeter trainieren: Technik und Nervenstärke',
  metaDescription:
    'Siebenmeter im Handball sicher verwandeln: Technik, Wurfvarianten und Nervenstärke. So trainierst du deine Schützen und hebst die Siebenmeterquote spürbar an.',
  keywords: [
    'siebenmeter handball',
    'siebenmeter trainieren',
    'siebenmeter technik handball',
    '7 meter handball',
    'siebenmeter werfen tipps',
