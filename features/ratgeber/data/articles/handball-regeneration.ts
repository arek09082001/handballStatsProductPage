...
export const handballRegeneration: Article = {
  slug: 'handball-regeneration',
  title: 'Regeneration im Handball: schneller erholen zwischen Training und Spiel',
  metaTitle: 'Regeneration im Handball: richtig erholen',
  metaDescription:
    'Regeneration im Handball: Schlaf, Ernährung, aktive Erholung und Belastungssteuerung richtig einsetzen. So bleibst du leistungsfähig und verletzungsfrei.',
  keywords: [
    'regeneration handball',
    'erholung nach handballspiel',
    'muskelkater handball',
    'regeneration sport tipps',
...
| Lockeres Schwimmen | am Tag nach dem Spiel |
| Mobility & Dehnen | regelmäßig, besonders Schulter, Hüfte, Waden |
| Faszienrolle | verspannte Bereiche, 1–2 Minuten pro Muskelgruppe |
| Spaziergang | an spielfreien Tagen |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Tore, Fehler und Wurfquoten live per Tap – auch im Zeitverlauf des Spiels. So erkennst du, ob dein Team am Ende einbricht und ob die Belastungssteuerung der Woche gepasst hat. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Wie viele Ruhetage braucht man im Handball?',
      answer:
    ...
    {
      question: 'Was hilft gegen Muskelkater nach dem Handball?',
      answer:
    ...
    {
      question: 'Woran erkenne ich, dass ich zu viel trainiere?',
      answer:
