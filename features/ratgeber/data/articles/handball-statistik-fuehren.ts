...
export const handballStatistikFuehren: Article = {
  ...
  keywords: [
    ...
    'handball spielstatistik',
    'statistik handball trainer',
    'handball kennzahlen',
    'handball statistikbogen',
    'handball daten erfassen',
  ],
...
| Spielerin | Tore | Würfe | Techn. Fehler | Wurfquote |
| --- | --- | --- | --- | --- |
| Kreis | 5 | 6 | 3 | 83,3 % |
| Außen links | 4 | 7 | 1 | 57,1 % |
| Rückraum Mitte | 7 | 12 | 5 | 58,3 % |
| Rückraum links | 6 | 11 | 2 | 54,5 % |
| Rückraum rechts | 4 | 7 | 1 | 57,1 % |
| Außen rechts | 2 | 2 | 0 | 100,0 % |
| **Team** | **28** | **45** | **12** | **62,2 %** |
...
Ob du das auf Papier, in einer Tabelle oder in einer App machst, ist zweitrangig – wichtiger ist, dass ihr es durchhaltet. Für den Einstieg reicht die [Excel-Vorlage für die Handball-Statistik](/handball-statistik-excel-vorlage); wenn das Mitschreiben am Spielfeldrand zu langsam wird, übernimmt eine App die Erfassung per Tap, auch offline in der Halle. Welcher Weg zu deiner Situation passt, klärt der Vergleich [Zettel, Excel oder App](/ratgeber/handball-statistik-zettel-excel-app).`,
  modules: [
    {
      kind: 'answerBox',
      text: 'Für die meisten Trainerentscheidungen reichen vier Werte pro Spieler: Tore, Würfe, technische Fehler und ungefähre Einsatzzeit – plus die Zahl der Angriffe für die Mannschaft. Daraus rechnest du Wurfquote, Angriffseffektivität und Fehlerquote. Alles Weitere ist Ausbaustufe zwei.',
    },
    {
      after: 'Die vier Grundrechnungen einer Handballstatistik',
      kind: 'formula',
      label: 'Die Zahl, die mehr sagt als die Wurfquote',
      formula: 'Angriffseffektivität (%) = Tore ÷ Angriffe × 100',
      example:
        '28 Tore aus 52 Angriffen ergeben 53,8 %. Die Wurfquote lag im selben Spiel bei 62,2 % – die Differenz sind die Angriffe, die ohne Abschluss endeten.',
    },
    {
      after: 'Wie viel Erfassung deine Spielklasse verträgt',
      kind: 'benchmarkTable',
      caption: 'Drei Ausbaustufen',
      columns: ['Stufe', 'Was du erfasst', 'Personen am Spielfeldrand', 'Wofür es reicht'],
      rows: [
        [
          'Einstieg',
          'Tore und Würfe je Spieler',
          '1',
          'Wurfquote, Torschützenverteilung',
        ],
        [
          'Arbeitsniveau',
          '+ technische Fehler, Angriffe, Paraden',
          '1–2',
          'Angriffseffektivität, Fehlerquote, Torwartleistung',
        ],
        [
          'Ausbau',
          '+ Wurfzonen, Blocks, Ballgewinne, Zeiten',
          '2',
          'Wurfbilder, Abwehrbewertung, Phasenanalyse',
        ],
      ],
      note: 'Die Stufen sind eine Planungshilfe, keine Norm. Entscheidend ist, eine Stufe über eine ganze Halbserie durchzuhalten, statt zwischen ihnen zu springen.',
    },
  ],
  faqs: [
    {
    ...
    {
      question: 'Wie berechnet man die Angriffseffektivität im Handball?',
      answer:
    ...
    {
      question: 'Wie viele Spiele braucht man, bevor die Zahlen aussagekräftig sind?',
      answer:
