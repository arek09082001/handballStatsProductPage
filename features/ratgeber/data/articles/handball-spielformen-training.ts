...
export const handballSpielformenTraining: Article = {
  ...
  keywords: [
    ...
    'handball training spielnah',
    'handball 4 gegen 4',
    'spielform lenken handball',
    'handball trainingsformen',
  ],
  ...
  imageAlt: 'Trainer erfasst Aktionen einer Spielform in der Statix Handball-App',
  body: `"Wir spielen zum Abschluss noch" ist in den meisten Hallen das Gegenteil von Training: 14 Spieler, ein Feld, keine Regel außer den offiziellen, und der Trainer schaut zu. Dabei ist die Spielform das wirksamste Werkzeug, das du hast – wenn du sie steuerst.
  ...
  modules: [
    {
      ...
      caption: '90 Minuten fast ohne isolierte Übungen',
      blocks: [
        {
          minutes: 12,
          label: 'Aufwärmen als Fangspiel mit Ball',
          note: 'Zwei Fänger, alle anderen mit Ball – Ballhandling und Puls in einem.',
        },
        {
          minutes: 15,
          label: 'Form 1 – Überzahl im kleinen Feld',
          note: 'Drei Durchgänge à vier Minuten, eine Minute Pause.',
        },
        {
          minutes: 18,
          label: 'Form 2 und 3 – Zielverhalten erzwingen',
          note: 'Regel und Wertung setzen den Schwerpunkt der Woche.',
        },
        {
          minutes: 20,
          label: 'Form 4 – Umschalten',
          note: 'Höchste Intensität der Einheit, klare Pausen.',
        },
        {
          minutes: 20,
          label: 'Form 5 – Abschlussspiel mit einer Regel',
          note: 'Nah am echten Spiel, genau eine Bedingung bleibt.',
        },
        { minutes: 5, label: 'Auslaufen und Rückmeldung' },
      ],
    },
    {
      after: 'Fünf Spielformen mit klarem Auftrag',
      kind: 'exercise',
      name: '1 · Vier gegen drei im halben Feld',
      meta: '15 Min. · ab D-Jugend · Ziel: Überzahl erkennen',
      setup: 'Halbes Feld, ein Tor mit Torwart, vier Angreifer gegen drei Verteidiger.',
      organisation:
      ...
      commonError:
        'Der Ball wird so lange gepasst, bis die Überzahl weg ist. Erkennbar daran, dass die Abwehr sortiert steht, wenn der Abschluss kommt.',
      variation: 'Der vierte Angreifer startet zwei Sekunden verzögert – so entsteht die Überzahl im Lauf.',
    },
    {
      after: 'Fünf Spielformen mit klarem Auftrag',
      kind: 'exercise',
      name: '2 · Doppelte Punkte für Kreistore',
      meta: '9 Min. · ab C-Jugend · Ziel: Kreisanspiel',
      setup: 'Fünf gegen fünf plus Torhüter im ganzen Feld, ein Kreisläufer je Mannschaft.',
      organisation:
      ...
      commonError:
        'Alle spielen nur noch zum Kreis und der Rückraum wirft gar nicht mehr. Dann ist die Wertung zu stark – reduziere auf anderthalb Punkte oder begrenze die doppelten Tore auf drei je Durchgang.',
    },
    {
      after: 'Fünf Spielformen mit klarem Auftrag',
      kind: 'exercise',
      name: '3 · Drei gegen drei ohne Prellen',
      meta: '9 Min. · ab D-Jugend · Ziel: Anspielbereitschaft',
      setup: 'Feld von etwa 15 × 12 Metern, Hütchentore, Prellen verboten.',
      organisation: 'Ständiger Wechsel nach jedem Tor, Durchgänge à drei Minuten.',
      coachingPoints: [
      ...
      commonError:
        'Die Spieler ohne Ball bleiben stehen und fordern. Ohne Prellen wird das sofort bestraft – genau darum funktioniert die Form.',
      variation: 'Ein Pass darf nicht zum letzten Passgeber zurück.',
    },
    {
      after: 'Fünf Spielformen mit klarem Auftrag',
      kind: 'exercise',
      name: '4 · Umschalten auf Pfiff',
      meta: '20 Min. · ab C-Jugend · Ziel: Rückzug und Zuordnung',
      setup: 'Fünf gegen fünf im ganzen Feld, zwei Tore mit Torhütern.',
      organisation:
      ...
      commonError:
        'Alle laufen gemeinsam zurück und niemand stört den Ballführenden. Das ist exakt das Bild, das im Spiel zu Gegenstoßtoren führt.',
    },
    {
      after: 'Fünf Spielformen mit klarem Auftrag',
      kind: 'exercise',
      name: '5 · Abschlussspiel mit einer Bedingung',
      meta: '20 Min. · ab E-Jugend · Ziel: Transfer',
      setup: 'Normales Spiel 6 gegen 6, aber mit genau einer Regel aus dem Schwerpunkt der Woche.',
      organisation:
      ...
      commonError:
        'Der Trainer coacht plötzlich alles Mögliche. Die Mannschaft verliert den Fokus, und die Form wird wieder zum normalen Spiel.',
    },
  ],
  relatedSlugs: [
