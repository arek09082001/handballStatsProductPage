...
export const handballKreislaeuferSpielen: Article = {
  slug: 'handball-kreislaeufer-spielen',
  title: 'Kreisläufer im Handball: Aufgaben, Technik und Tipps für die Position',
  metaTitle: 'Kreisläufer im Handball: Aufgaben, Technik & Tipps',
  metaDescription:
    'Kreisläufer im Handball: Aufgaben, Technik, Sperren und Anspiele erklärt. So spielst du die Position am Kreis erfolgreich – für Einsteiger und Trainer.',
  keywords: [
...
| Wurf | Situation |
| --- | --- |
| Drehwurf | nach Anspiel mit dem Rücken zum Tor, schnelle Drehung zur freien Seite |
| Fallwurf | im Fallen weg vom Abwehrspieler abschließen |
| Direktabschluss | schnelles Anspiel in die Lücke, sofort werfen |
| Nachwurf | zweite Welle nach einem Fehlwurf |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Tore, Wurfquoten je Position und technische Aktionen live per Tap. So siehst du, wie stark dein Kreisläufer aus dem Nahbereich trifft und wie viel Gefahr über den Kreis entsteht – Zahlen, die ein Blick allein nicht liefert. Teste es kostenlos und ohne Account in der Live-Demo unter demo.statix-app.de.`,
  faqs: [
    ...
    {
      question: 'Was ist eine Sperre im Handball?',
      answer:
