...
export const handballNervositaetVorSpielen: Article = {
  slug: 'handball-nervositaet-vor-spielen',
  title: 'Nervosität vor Handballspielen: ruhig und fokussiert ins Spiel gehen',
  metaTitle: 'Nervosität vor dem Handballspiel bekämpfen',
  metaDescription:
    'Nervosität vor Handballspielen in den Griff bekommen: Routinen, Atemtechnik und mentale Tricks gegen Lampenfieber – für Spieler, Torhüter und Jugendliche.',
  keywords: [
    'nervosität vor handballspiel',
    'lampenfieber handball',
    'nervös vor spiel handball',
    'wettkampfangst sport',
...
| Ergebnisgedanke | Aufgabengedanke |
| --- | --- |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, werden Tore, Würfe und Fehler live per Tap erfasst. So siehst du nach dem Spiel die echte Bilanz statt der gefühlten – und erkennst über die Saison, dass einzelne Fehler nie das Gesamtbild bestimmen. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Ist Nervosität vor Spielen schlecht?',
      answer:
    ...
    {
      question: 'Wie komme ich schneller im Spiel an?',
      answer:
    ...
    {
      question: 'Wie können Trainer nervösen Spielern helfen?',
      answer:
