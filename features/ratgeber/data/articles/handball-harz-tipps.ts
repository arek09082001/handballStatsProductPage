...
export const handballHarzTipps: Article = {
  slug: 'handball-harz-tipps',
  title: 'Harz im Handball: Regeln, richtiger Umgang und Tipps für Einsteiger',
  metaTitle: 'Harz im Handball: Regeln & Tipps zum Umgang',
  metaDescription:
    'Harz im Handball richtig nutzen: Was erlaubt ist, wie viel Harz sinnvoll ist, wie du Hände und Ball reinigst und was du tust, wenn Harz verboten ist.',
  keywords: [
    'harz handball',
    'handball harz regeln',
    'handballharz benutzen',
    'harz entfernen handball',
    'handball ohne harz',
    'harz verbot halle',
    'backmittel handball',
  ],
...
| Situation | Bedeutung für dich |
| --- | --- |
| Harz erlaubt | klassisches Harz frei nutzbar, Reinigung trotzdem Pflicht |
| Nur wasserlösliches Harz | spezielle waschbare Backmittel verwenden |
| Harzverbot | gar kein Harz – Verstöße können den Verein Hallenzeiten kosten |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Tore, Fehlwürfe und technische Fehler live per Tap und siehst sofort, wo dein Team den Ball verliert und aus welchen Positionen es effizient abschließt. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Wie viel Harz sollte man benutzen?',
      answer:
    ...
    {
      question: 'Wie bekommt man Handballharz von den Händen?',
      answer:
    ...
    {
      question: 'Sollten Kinder und Jugendliche mit Harz spielen?',
      answer:
