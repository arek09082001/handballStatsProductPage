...
export const handballTimeoutNutzen: Article = {
  slug: 'handball-timeout-nutzen',
  title: 'Team-Timeout im Handball: die grüne Karte richtig einsetzen',
  metaTitle: 'Team-Timeout im Handball nutzen',
  metaDescription:
    'Team-Timeout im Handball richtig nutzen: Regeln der grünen Karte, der beste Zeitpunkt, was du in 60 Sekunden ansprichst und typische Fehler beim Nehmen der Auszeit.',
  keywords: [
    'team timeout handball',
    'grüne karte handball',
    'auszeit handball',
    'timeout handball regeln',
    'auszeit richtig nehmen',
...
| Situation | Ziel des Timeouts |
| --- | --- |
| Gegner läuft mehrere Tore in Serie | den Lauf brechen, Ruhe reinbringen |
| Eigene Mannschaft wird nervös/hektisch | beruhigen, Struktur zurückgeben |
| Wichtige Schlussphase | Spielzug festlegen, Aufstellung klären |
| Nach eigener Zeitstrafe | Unterzahl-Verhalten abstimmen |
| Vor einer entscheidenden Angriffssituation | einen konkreten Spielzug ansagen |
...
Die Frage, wann ein Lauf gefährlich wird, lässt sich mit Zahlen schärfen. Mit **Statix**, der Handball-Statistik-App für Trainer, siehst du in Echtzeit, wie sich Effektivität und Torfolge entwickeln – so erkennst du einen Negativlauf früh und ziehst dein Timeout, bevor der Vorsprung schmilzt. Nach dem Spiel lässt sich sogar auswerten, wie eure Mannschaft nach Auszeiten agiert hat. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    ...
    {
      question: 'Wann darf man ein Team-Timeout nehmen?',
      answer:
