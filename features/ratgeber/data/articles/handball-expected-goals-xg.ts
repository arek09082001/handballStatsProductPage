...
export const handballExpectedGoalsXg: Article = {
  ...
  title: 'Expected Goals (xG) im Handball: erwartbare Tore verstehen und nutzen',
  metaTitle: 'Expected Goals (xG) im Handball',
  metaDescription:
    'Expected Goals im Handball einfach erklärt: Was xG bedeutet, wie erwartbare Tore aus Wurfposition und -situation entstehen und wie Trainer die Kennzahl sinnvoll nutzen.',
  keywords: [
    'expected goals handball',
    'xg handball',
    'erwartbare tore',
    'wurfqualität messen',
    'handball advanced stats',
...
1. **Viele Tore, aber niedriges xG:** Die Mannschaft trifft überdurchschnittlich – schön, aber schwer haltbar. Erwarte einen Rückgang, wenn die Quote sich normalisiert.
2. **Hohes xG, wenige Tore:** Gute Chancen bleiben ungenutzt. Hier lohnt gezieltes Abschlusstraining und ein Blick auf die Nervenstärke in engen Phasen.
3. **Niedriges xG insgesamt:** Die Mannschaft kommt nicht zu guten Würfen. Das ist ein Struktur- und Taktikproblem – die Auslösehandlungen greifen nicht.

## So erfasst du xG im Amateurbereich

Du musst kein Datenteam sein. Ein praktikabler Weg:

1. Teile das Tor-Umfeld in Wurfzonen ein (Kreis, Nahdistanz, Rückraum links/Mitte/rechts, Außen, Tempogegenstoß, Siebenmeter).
2. Weise jeder Zone einen groben Erfahrungswert zu – zum Beispiel aus deinen eigenen Saisondaten.
3. Erfasse zu jedem Wurf die Zone und ob Über-/Unterzahl herrschte.
4. Summiere die Werte pro Spiel und vergleiche sie mit den tatsächlichen Toren.
...
Der Aufwand steht und fällt mit der Erfassung. Mit **Statix**, der Handball-Statistik-App für Trainer, tippst du jeden Wurf live auf einer Torfläche ein – Position, Ausgang und Situation. Daraus entstehen automatisch Wurfbilder und Zonenauswertungen, aus denen sich Chancenqualität ablesen lässt. So diskutierst du nach dem Spiel nicht über Gefühl, sondern über erspielte Würfe. Teste es kostenlos und ohne Account in der Live-Demo unter demo.statix-app.de.`,
  faqs: [
    ...
    {
      question: 'Welche Faktoren beeinflussen den xG-Wert?',
      answer:
