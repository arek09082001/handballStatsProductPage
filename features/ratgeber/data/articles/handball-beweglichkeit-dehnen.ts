...
export const handballBeweglichkeitDehnen: Article = {
  slug: 'handball-beweglichkeit-dehnen',
  title: 'Beweglichkeit und Dehnen im Handball: Mobility für Schulter, Hüfte und Rumpf',
  metaTitle: 'Beweglichkeit & Dehnen im Handball',
  metaDescription:
    'Beweglichkeit im Handball verbessern: dynamisches Dehnen vor dem Spiel, statisches Dehnen danach und Mobility-Übungen für Wurfschulter, Hüfte und Sprunggelenk.',
  keywords: [
    'beweglichkeit handball',
    'dehnen handball',
    'mobility handball',
    'schulter beweglichkeit wurf',
    'dynamisches dehnen aufwärmen',
    'statisches dehnen',
    'handball stretching',
  ],
...
| Zeitpunkt | Methode | Warum |
| --- | --- | --- |
| Vor Training/Spiel | dynamisches Dehnen | aktiviert Muskeln, bereitet auf Bewegung vor |
| Nach Training/Spiel | statisches Dehnen | fördert Entspannung und Regeneration |
...
Beweglichkeit und Regeneration hängen eng mit der Gesamtbelastung zusammen. Wer Spiel- und Trainingsbelastung im Auge behält, dosiert auch die Mobility-Arbeit sinnvoller. Mit **Statix**, der Handball-Statistik-App für Trainer, behältst du Einsatzzeiten und Spielbelastung deiner Spieler über die Saison im Blick – eine gute Grundlage, um Training, Dehnen und Erholung aufeinander abzustimmen. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
