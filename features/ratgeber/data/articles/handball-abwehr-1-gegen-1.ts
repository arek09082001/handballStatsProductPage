...
export const handballAbwehr1Gegen1: Article = {
  slug: 'handball-abwehr-1-gegen-1',
  title: 'Zweikampf in der Abwehr: besser verteidigen im 1 gegen 1',
  metaTitle: 'Abwehr-Zweikampf im Handball verbessern',
  metaDescription:
    'Im Handball besser verteidigen: Beinarbeit, Körperposition und Timing im Abwehr-Zweikampf. So gewinnst du das 1 gegen 1 gegen jeden Angreifer – ohne Zeitstrafe.',
  keywords: [
    'handball abwehr zweikampf',
    '1 gegen 1 abwehr handball',
    'verteidigen lernen handball',
    'beinarbeit abwehr handball',
...
| Erlaubt | Verboten (progressive Strafen) |
| --- | --- |
| den Weg mit dem Körper versperren | Klammern, Festhalten des Trikots |
| Kontakt mit angewinkelten Armen frontal | Stoßen in den Rücken |
| den Wurfarm regelgerecht stören | Schlagen auf den Wurfarm |
| Begleiten des Angreifers mit Körperkontakt | Wegziehen, Umreißen, Beinstellen |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du neben Toren auch Ballgewinne, technische Fehler des Gegners und Gegentore live per Tap. So wird sichtbar, wie stabil deine Abwehr wirklich steht – und welche Zweikämpfe den Unterschied machen. Teste es kostenlos und ohne Account in der Live-Demo unter demo.handballwebseite.de.`,
  faqs: [
    ...
    {
      question: 'Wie vermeide ich Zeitstrafen in der Abwehr?',
      answer:
    ...
    {
      question: 'Worauf soll ich beim Verteidigen schauen – Ball oder Körper?',
      answer:
