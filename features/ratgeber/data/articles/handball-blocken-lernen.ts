...
export const handballBlockenLernen: Article = {
  ...
  keywords: [
    ...
    'blocktechnik handball',
    'handball abwehr block',
    'block torwart absprache',
    'handball blocken üben',
    'blockspiel handball',
  ],
  ...
  imageAlt: 'Abwehrwerte und Gegentorverteilung einer Handballmannschaft in der Statix-App',
  body: `Blocken ist die Technik mit dem schlechtesten Verhältnis zwischen Wirkung und Trainingszeit. Ein funktionierender Block halbiert die Torgefahr aus dem Rückraum, und in den meisten Amateurmannschaften wird er nie systematisch geübt – Blockarbeit gilt als Sache von Größe und Mut.
  ...
  modules: [
    {
      ...
      caption: '30-Minuten-Block im Abwehrtraining',
      blocks: [
        {
          minutes: 5,
          label: 'Handstellung ohne Ball',
          note: 'Sprünge an der Wand, Finger gespreizt, Arme gestreckt.',
        },
        {
          minutes: 7,
          label: 'Übung 1 – Timing bei halber Härte',
          note: 'Werfer wirft angekündigt, Block übt den Absprungzeitpunkt.',
        },
        {
          minutes: 8,
          label: 'Übung 2 – Wurf oder Finte',
          note: 'Der Werfer entscheidet, der Block darf nur auf den echten Wurf springen.',
        },
        {
          minutes: 6,
          label: 'Übung 3 – Zweierblock mit Torwart',
          note: 'Absprache über die abgedeckte Ecke, laut ausgesprochen.',
        },
        {
          minutes: 4,
          label: 'Übung 4 – Abpraller verwerten',
          note: 'Nach jedem Blockkontakt sofort zum Ball und Gegenstoß einleiten.',
        },
      ],
    },
    {
      after: 'Vier Übungen für Timing und Absprache',
      kind: 'exercise',
      name: '1 · Absprung auf den echten Wurf',
      meta: '7 Min. · ab C-Jugend',
      setup:
      ...
      commonError:
        'Absprung bei der Ausholbewegung. Der Block ist beim Durchziehen schon wieder unten und die Ecke, die der Torwart freigelassen hat, steht offen.',
      variation:
        'Der Werfer darf zwischen Sprungwurf und Schlagwurf wählen – der Absprungzeitpunkt unterscheidet sich deutlich.',
    },
    {
      after: 'Vier Übungen für Timing und Absprache',
      kind: 'exercise',
      name: '2 · Wurf oder Finte',
      ...
      commonError:
        'Der Blockspieler reagiert auf den Ball statt auf den Körper. Der Ball ist genau das, was die Finte manipuliert.',
    },
    {
      after: 'Vier Übungen für Timing und Absprache',
      kind: 'exercise',
      name: '3 · Zweierblock mit Torwart',
      meta: '6 Min. · ab B-Jugend',
      setup:
      ...
      commonError:
        'Der Block wechselt während des Sprungs die Seite, weil der Werfer sich bewegt. Für den Torwart ist das die schlimmste aller Varianten.',
      variation:
        'Die Ansage entfällt und wird durch eine feste Regel ersetzt: Der Block macht immer die lange Ecke zu.',
    },
    {
      after: 'Vier Übungen für Timing und Absprache',
      kind: 'exercise',
      name: '4 · Abpraller verwerten',
      meta: '4 Min. · ab C-Jugend',
      setup:
      ...
      commonError:
        'Alle schauen dem Ball hinterher, statt ihn zu holen. Die beste Ballgewinnsituation im Handball wird so regelmäßig verschenkt.',
    },
  ],
  faqs: [
    {
      ...
      answer:
        'Arme senkrecht nach oben, Finger gespreizt und aktiv angespannt, Daumen nicht verschränkt, Rumpf unter Spannung. Der Absprung erfolgt erst, wenn der Wurfarm des Schützen tatsächlich nach vorn beschleunigt. Arme nach vorn zum Werfer erzeugen eine kleinere Blockfläche und Zeitstrafen.',
    },
    {
    ...
    {
      question: 'Ab welchem Alter sollte man Blocken trainieren?',
      answer:
