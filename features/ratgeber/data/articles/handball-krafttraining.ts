...
export const handballKrafttraining: Article = {
  slug: 'handball-krafttraining',
  title: 'Krafttraining im Handball: Übungen für mehr Wurfkraft und Stabilität',
  metaTitle: 'Krafttraining im Handball: Übungen für Wurfkraft',
  metaDescription:
    'Krafttraining im Handball richtig aufbauen: Übungen für Rumpf, Beine und Wurfarm, Trainingsplan und Tipps. So bekommst du mehr Wurfkraft, Zweikampfstärke und Stabilität.',
  keywords: [
    'krafttraining handball',
    'handball wurfkraft trainieren',
    'handball krafttraining übungen',
    'rumpfstabilität handball',
...
Genau hier hilft dir **Statix**, die Handball-Statistik-App für Trainer: Du erfasst Tore, Wurfquoten und technische Fehler live per Tap und siehst über die Saison, ob deine Athletikarbeit auf dem Feld ankommt. So verbindest du Kraftraum und Spielrealität mit echten Zahlen statt mit Bauchgefühl. Probier es unverbindlich in der kostenlosen Live-Demo ohne Account unter demo.handballwebseite.de aus.`,
  faqs: [
    ...
    {
      question: 'Welche Übungen verbessern die Wurfkraft im Handball?',
      answer:
    ...
    {
      question: 'Macht Krafttraining Handballer langsam oder unbeweglich?',
      answer:
