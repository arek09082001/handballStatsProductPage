...
export const handballMinihandballKinder: Article = {
  ...
  title: 'Minihandball: Handball mit Kindern spielerisch beibringen',
  metaTitle: 'Minihandball: Handball mit Kindern beibringen',
  metaDescription:
    'Minihandball mit Kindern: spielerisch Handball beibringen, Training gestalten und Spaß fördern. Praxistipps für Trainer der Jüngsten von 5 bis 8 Jahren.',
  keywords: [
    'minihandball',
    'handball mit kindern',
    'minihandball training',
    'handball kindergarten grundschule',
    'handball für anfänger kinder',
    'ballschule handball',
    'kinderhandball training',
  ],
...
| --- | --- | --- |
| Ankommen/Aufwärmen | ein Lauf- oder Fangspiel | 10 Min |
| Ballgewöhnung | Übungen mit vielen Ballkontakten | 10–15 Min |
| Hauptteil | kleine Spielformen, Werfen, Parcours | 20–25 Min |
| Abschluss | ein beliebtes Spiel als Höhepunkt | 10 Min |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, kannst du Anwesenheit und die Entwicklung deiner Spieler über die Zeit festhalten – unaufgeregt und ohne Leistungsdruck. So behältst du auch bei der jüngsten Gruppe den Überblick und siehst, wie sich dein Nachwuchs Schritt für Schritt entwickelt. Was das konkret für den Nachwuchsbereich bedeutet, haben wir unter [Handball-Statistik für Jugendtrainer](/fuer-jugendtrainer) zusammengefasst. Teste es kostenlos und ohne Account in der Live-Demo unter demo.statix-app.de.`,
  faqs: [
    {
