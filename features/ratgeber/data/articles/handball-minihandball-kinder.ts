...
export const handballMinihandballKinder: Article = {
  slug: 'handball-minihandball-kinder',
  ...
  keywords: [
    ...
    'minihandball übungen',
    'handball f jugend training',
    'handball kindertraining anleiten',
    'ballschule handball',
    'handball einsteiger kinder',
  ],
  ...
  imageAlt: 'Kindergruppe im Minihandball-Training in der Halle',
  body: `Die härteste Trainingsstunde im Verein ist nicht die A-Jugend. Es sind zwanzig Kinder zwischen fünf und acht Jahren, von denen drei noch nie einen Ball gefangen haben, zwei nicht mitmachen wollen und eines gerade weint. Wer diese Stunde mit Technikübungen plant, verliert sie in den ersten zehn Minuten.
  ...
  modules: [
    {
      ...
      caption: '60 Minuten für 16 bis 24 Kinder',
      blocks: [
        {
          minutes: 8,
          label: 'Ankommen und Fangspiel',
          note: 'Sofort Bewegung, keine Begrüßungsrunde im Sitzen.',
        },
        {
          minutes: 10,
          label: 'Bewegungslandschaft',
          note: 'Form 1 – Matten, Bänke, Kästen. Klettern, springen, rollen.',
        },
        {
          minutes: 10,
          label: 'Ballgewöhnung frei',
          note: 'Form 2 – jedes Kind ein Ball, wechselnde Aufgaben.',
        },
        {
          minutes: 12,
          label: 'Zielwerfen in Stationen',
          note: 'Form 3 – vier Stationen parallel, kein Warten.',
        },
        {
          minutes: 15,
          label: 'Kleine Spiele',
          note: 'Form 4 und 5 – mehrere kleine Felder statt eines großen.',
        },
        { minutes: 5, label: 'Abschlusskreis', note: 'Kurz, im Stehen, mit einer Frage an die Gruppe.' },
      ],
    },
    {
      after: 'Fünf Formen, die alle beschäftigen',
      kind: 'exercise',
      name: '1 · Bewegungslandschaft',
      meta: '10 Min. · 5–8 Jahre',
      setup:
      ...
      commonError:
        'Der Aufbau erzeugt einen Engpass, an dem sich alle stauen. Erkennbar an einer Traube vor einem Gerät – dann fehlt eine zweite parallele Bahn.',
      variation: 'Mit Ball in der Hand durch den Parcours, später prellend.',
    },
    {
      after: 'Fünf Formen, die alle beschäftigen',
      kind: 'exercise',
      name: '2 · Jeder Ball ist anders',
      meta: '10 Min. · 5–8 Jahre',
      setup:
      ...
      commonError:
        'Der Trainer korrigiert die Wurftechnik. In dieser Altersstufe entsteht Technik aus Wiederholung, nicht aus Korrektur.',
    },
    {
      after: 'Fünf Formen, die alle beschäftigen',
      kind: 'exercise',
      name: '3 · Vier Ziele, vier Gruppen',
      meta: '12 Min. · 6–8 Jahre',
      setup:
      ...
      commonError:
        'An einer Station liegen alle Bälle, an der anderen keiner mehr. Ein Kind je Gruppe bekommt die Aufgabe, Bälle zurückzubringen.',
      variation: 'Aus dem Lauf werfen statt aus dem Stand, sobald es klappt.',
    },
    {
      after: 'Fünf Formen, die alle beschäftigen',
      kind: 'exercise',
      name: '4 · Drei gegen drei auf vier Feldern',
      meta: '8 Min. · 6–8 Jahre',
      setup: 'Die Halle wird in vier kleine Felder geteilt, je zwei Hütchentore.',
      organisation:
      ...
      commonError:
        'Ein großes Spiel statt vier kleiner. Bei 6 gegen 6 haben zwei Kinder den Ball und zehn schauen zu.',
    },
    {
      after: 'Fünf Formen, die alle beschäftigen',
      kind: 'exercise',
      name: '5 · Jäger und Ball',
      meta: '7 Min. · 5–8 Jahre',
      setup: 'Freies Feld, zwei bis drei Kinder mit Softball als Fänger.',
      organisation:
      ...
      commonError:
        'Abgeworfene Kinder müssen aussetzen. Dann sitzen nach drei Minuten die unsichersten Kinder am Rand – genau die, die Bewegung am nötigsten hätten.',
    },
  ],
  faqs: [
    {
    ...
    {
      question: 'Wie gehe ich mit sehr unterschiedlichen Leistungsständen um?',
      answer:
