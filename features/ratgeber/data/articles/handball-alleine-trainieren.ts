...
export const handballAlleineTrainieren: Article = {
  slug: 'handball-alleine-trainieren',
  title: 'Handball alleine trainieren: Übungen für zu Hause und draußen',
  metaTitle: 'Handball alleine trainieren: die besten Übungen',
  metaDescription:
    'Handball alleine trainieren: Ballhandling, Wurftechnik, Athletik und Spielverständnis ohne Halle verbessern. Mit Übungen für zu Hause, Garten und Wand.',
  keywords: [
    'handball alleine trainieren',
    'handball training zu hause',
    'handball üben ohne halle',
    'ballhandling zu hause',
...
| Bereich | Übungen |
| --- | --- |
| Beine & Sprungkraft | Kniebeugen, Ausfallschritte, Sprungkniebeugen, einbeinige Sprünge |
| Rumpf | Planks (vorne/seitlich), Käfer, Rückenstrecker |
| Schulter & Arme | Liegestütze (auch erhöht), Schulterkreisen mit Theraband |
| Schnelligkeit | Antritte über 10–20 Meter, Skippings, Seilspringen |
| Beweglichkeit | Hüftöffner, Schulterdehnung, Wadendehnung |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, sieht dein Trainer deine Spieldaten über die ganze Saison: Wurfquote, Tore, Fehler. So erkennst du, ob sich dein Extratraining in echten Spielen auszahlt. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Welche Handball-Übungen kann ich zu Hause machen?',
      answer:
    ...
    {
      question: 'Wie oft sollte ich zusätzlich zum Mannschaftstraining üben?',
      answer:
    ...
    {
      question: 'Wie verbessere ich mein Spielverständnis ohne Halle?',
      answer:
