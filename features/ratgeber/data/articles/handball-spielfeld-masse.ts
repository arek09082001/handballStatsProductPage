...
export const handballSpielfeldMasse: Article = {
  slug: 'handball-spielfeld-masse',
  title: 'Handballfeld: Maße, Linien und Markierungen einfach erklärt',
  metaTitle: 'Handballfeld: Maße & Markierungen',
  metaDescription:
    'Das Handballfeld im Detail: Maße von 40 mal 20 Metern, Torraumlinie, Freiwurflinie, Siebenmeterlinie, Torwart-Grenzlinie und Torgröße – alle Markierungen verständlich erklärt.',
  keywords: [
    'handballfeld maße',
    'handball spielfeld',
    'handball linien erklärt',
    'torraumlinie handball',
    'freiwurflinie handball',
    'siebenmeterlinie',
    'handball tor größe',
  ],
...
| Siebenmeterlinie | 7 Meter vor Tormitte |
| Torwart-Grenzlinie | 4 Meter vom Tor |
...
Weil das Feld überall gleich vermessen ist, lassen sich Wurfpositionen sauber vergleichen. Mit **Statix**, der [Handball-Statistik-App mit Wurfbild](/), ordnest du jeden Wurf einer Zone auf dem Feld zu und erkennst im Wurfbild, aus welchen Bereichen eure Tore fallen. So werden abstrakte Linien zu konkreten Erkenntnissen über euer Spiel. Wie daraus Quoten je Zone entstehen, zeigt der Ratgeber [Wurfquote berechnen](/ratgeber/wurfquote-berechnen). Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Was bedeuten die verschiedenen Linien auf dem Handballfeld?',
      answer:
    ...
    {
      question: 'Warum darf man den Torraum nicht betreten?',
      answer:
    ...
    {
      question: 'Wie unterscheiden sich Freiwurflinie und Siebenmeterlinie?',
      answer:
