...
export const handballSiebenmeterHalten: Article = {
  slug: 'handball-siebenmeter-halten',
  title: 'Siebenmeter halten: So liest du als Torwart den Werfer',
  metaTitle: 'Siebenmeter halten: Tipps für Torhüter',
  metaDescription:
    'Siebenmeter halten im Handball: Wie Torhüter den Werfer lesen, das Nervenduell gewinnen und mit Strategie statt Glück parieren. Mit Tipps und Übungen.',
  keywords: [
    'siebenmeter halten',
    'handball torwart siebenmeter',
    '7 meter halten handball',
    'werfer lesen handball',
    'siebenmeter duell torwart',
    'strafwurf halten',
...
| Signal | Hinweis |
| --- | --- |
| Anlauf und Standposition | Wurfwinkel und bevorzugte Seite |
| Höhe des Ellenbogens | hoher oder flacher Wurf |
| Handgelenkstellung | Dreher, Heber oder gerader Wurf |
| Blickverhalten | manche Schützen schauen in ihre Ecke, andere täuschen bewusst |
| Wurftempo | Vollspannschützen mögen die Ecken, Techniker warten auf deine Bewegung |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, werden Siebenmeter, Paraden und Gegentore live per Tap erfasst. So siehst du deine Siebenmeterquote über die Saison, erkennst Muster und machst aus dem Strafwurf Schritt für Schritt ein faires Duell. Teste es kostenlos und ohne Account in der Live-Demo unter demo.handballwebseite.de.`,
  faqs: [
    ...
    {
      question: 'Was ist eine gute Siebenmeterquote für Torhüter?',
      answer:
    ...
    {
      question: 'Wie weit darf der Torwart beim Siebenmeter herauskommen?',
      answer:
    ...
    {
      question: 'Soll man als Torwart beim Siebenmeter eine Ecke raten?',
      answer:
