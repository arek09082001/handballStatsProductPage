...
export const handballJugendtrainerKennzahlenErstesJahr: Article = {
  slug: 'handball-jugendtrainer-kennzahlen-erstes-jahr',
  ...
  keywords: [
    ...
    'handball jugendtraining messen',
    'handball nachwuchs statistik',
    'handball erstes jahr trainer',
    'handball jugend entwicklung messen',
...
1. **Technische Fehler je Einsatzzeit.** Der beste Ausbildungsindikator dieser Stufe. Er reagiert schnell auf Trainingsarbeit und hängt kaum an Körpergröße.
2. **Anteil der Aktionen über die schwache Seite.** Der zuverlässigste Hinweis darauf, ob deine Ausbildung breit ist. Zähl ihn stichprobenartig in einer Übung, nicht im Spiel.
3. **Vielfalt der genutzten Wurfarten.** Ein Spieler, der drei Wurfarten einsetzt, ist weiter als einer mit einer harten. Grob notieren reicht.
4. **Anwesenheit.** Bleibt auch hier die ehrlichste Zahl.
...
1. **Führ ab dem ersten Training eine Anwesenheitsliste.** Zwei Minuten pro Einheit, und nach einer Saison hast du die aussagekräftigste Zahl, die es in der Jugendarbeit gibt.
2. **Wähl genau eine Leistungskennzahl** – bei D- und C-Jugend die technischen Fehler je Einsatzzeit – und halte sie eine ganze Halbserie durch.
3. **Notiere nach jeder Einheit zwei Namen:** wer heute etwas Neues geschafft hat und wer am Rand stand. Diese Notiz verändert dein nächstes Training mehr als jede Tabelle.
4. **Sprich Zahlen nie als Rangliste vor der Gruppe an.** Im Nachwuchs ist das der schnellste Weg dazu, dass Kinder aufhören, Risiken einzugehen – und danach misst du nur noch die Reaktion auf deine Messung.
5. **Setz pro Spieler und Halbserie ein Entwicklungsziel**, formuliert als beobachtbares Verhalten. Nicht drei. Wer sich auf drei Dinge konzentrieren soll, konzentriert sich auf keins.
...
Wenn du an einem Punkt unsicher bist, wähle im Zweifel die Zahl, die weniger misst. Ein Jahr mit vier sauber geführten Werten ist mehr wert als eine Tabelle mit zwanzig Spalten, in der ab Spiel sechs Lücken sind – der Rest ergibt sich, wenn du dabeibleibst.`,
  modules: [
    {
      after: 'Kennzahlen gegen diese Kriterien geprüft',
      kind: 'decisionMatrix',
      caption: 'Welche Zahl trägt im Nachwuchs?',
      criteria: [
        'Unabhängig von Frühentwicklung',
        'Zeigt auf einen Trainingsinhalt',
        'Ohne Rangliste nutzbar',
        'Allein erfassbar',
      ],
      options: [
        {
          name: 'Anwesenheit',
          scores: ['gut', 'gut', 'gut', 'gut'],
          verdict: 'Die wichtigste Zahl der Jugendarbeit – ab dem ersten Training führen',
        },
        {
          name: 'Technische Fehler je Einsatzzeit',
          scores: ['gut', 'gut', 'gut', 'geht'],
          verdict: 'Der beste Leistungswert für D- und C-Jugend',
        },
        {
          name: 'Aktionen über die schwache Seite',
          scores: ['gut', 'gut', 'gut', 'geht'],
          verdict: 'Stichprobenartig in einer Übung zählen, nicht im Spiel',
        },
        {
          name: 'Tore je Spieler',
          scores: ['schlecht', 'schlecht', 'schlecht', 'gut'],
          verdict: 'Belohnt Frühentwicklung und verändert das Verhalten – bewusst weglassen',
        },
        {
          name: 'Wurfquote als Rangliste',
          scores: ['schlecht', 'geht', 'schlecht', 'geht'],
          verdict: 'Erst ab B-Jugend und nur im Vergleich mit dem eigenen Vorwert',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'Sollte man im Jugendhandball überhaupt Statistik führen?',
      answer:
    ...
    {
      question: 'Welche Kennzahl sollte ein neuer Jugendtrainer zuerst führen?',
      answer:
    ...
    {
      question: 'Warum sind Tore im Jugendbereich eine schlechte Kennzahl?',
      answer:
    ...
    {
      question: 'Wie viele Entwicklungsziele soll ich pro Spieler setzen?',
      answer:
