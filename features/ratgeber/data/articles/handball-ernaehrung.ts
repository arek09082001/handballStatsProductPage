...
export const handballErnaehrung: Article = {
  slug: 'handball-ernaehrung',
  title: 'Ernährung im Handball: richtig essen vor, während und nach dem Spiel',
  metaTitle: 'Ernährung im Handball: vor, während & nach dem Spiel',
  metaDescription:
    'Ernährung im Handball: Was vor, während und nach Training und Spiel essen und trinken? Praktische Tipps zu Kohlenhydraten, Eiweiß und Flüssigkeit für mehr Leistung.',
  keywords: [
    'ernährung handball',
    'handball ernährung',
    'essen vor handballspiel',
    'ernährung vor dem spiel handball',
...
| --- | --- |
| 3–4 Stunden vorher | kohlenhydratreiche Hauptmahlzeit, wenig Fett, moderat Eiweiß |
| 1–2 Stunden vorher | kleiner, leichter Snack (Banane, Reiswaffel, etwas Brot) |
| kurz vorher | nur noch trinken, ggf. ein kleiner Snack bei Hunger |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Tore, Wurfquoten und Fehler live per Tap und siehst, wie sich die Leistung über die Spielzeit entwickelt. Ein deutlicher Leistungsabfall in der Schlussphase ist oft ein Hinweis auf Kondition, Ernährung oder Regeneration. Teste es kostenlos und ohne Account in der Live-Demo unter [demo.statix-app.de](https://demo.statix-app.de).`,
  faqs: [
    {
    ...
    {
      question: 'Was sollte man nach dem Handballspiel essen?',
      answer:
    ...
    {
      question: 'Was trinkt man am besten beim Handball?',
      answer:
    ...
    {
      question: 'Wie ernährt man sich an einem Handball-Turniertag?',
      answer:
