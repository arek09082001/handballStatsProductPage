...
export const handballSchlagwurfTechnik: Article = {
  slug: 'handball-schlagwurf-technik',
  title: 'Der Schlagwurf im Handball: Technik, Bewegungsablauf und Übungen',
  metaTitle: 'Schlagwurf im Handball: Technik & Bewegungsablauf',
  metaDescription:
    'Der Schlagwurf im Handball: Technik, Bewegungsablauf und typische Fehler. So lernst du den wichtigsten Grundwurf mit Schrittfolge, Ausholbewegung und Übungen.',
  keywords: [
    'schlagwurf handball',
    'schlagwurf technik handball',
    'schlagwurf lernen',
    'grundwurf handball',
...
| Körperteil | Beitrag |
| --- | --- |
| Beine/Stemmschritt | Stabilität und Kraftübertragung vom Boden |
| Hüfte | Beginn der Rotation, Hauptkraftquelle |
| Rumpf | überträgt die Drehung nach oben |
| Schulter/Arm | beschleunigt den Ball |
| Handgelenk | Drall, Präzision, letzter Impuls |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Würfe, Tore und Quoten je Spieler und Position live per Tap. So siehst du, welche Schützen wie effizient abschließen und ob sich die technische Arbeit am Schlagwurf in besseren Quoten niederschlägt. Teste es kostenlos und ohne Account in der Live-Demo unter demo.statix-app.de.`,
  faqs: [
    ...
    {
      question: 'Wie ist der Bewegungsablauf beim Schlagwurf?',
      answer:
    ...
    {
      question: 'Woher kommt die Wurfkraft beim Schlagwurf?',
      answer:
    ...
    {
      question: 'Was sind typische Fehler beim Schlagwurf?',
      answer:
