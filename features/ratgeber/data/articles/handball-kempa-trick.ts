...
export const handballKempaTrick: Article = {
  slug: 'handball-kempa-trick',
  title: 'Kempa-Trick lernen: der spektakulärste Spielzug im Handball',
  metaTitle: 'Kempa-Trick im Handball lernen',
  metaDescription:
    'Den Kempa-Trick lernen: Regeln, Technik von Anspiel und Abschluss, Trainingsaufbau und wann sich der Kempa im Spiel wirklich lohnt – Schritt für Schritt erklärt.',
  keywords: [
    'kempa trick handball',
    'kempa lernen',
    'kempa anspiel technik',
    'kempa trick regeln',
    'flugwurf handball',
    'kempa trainieren',
...
1. Absprung **vor** der Kreislinie
2. Fangen **und** Werfen in der Luft
3. Der Ball muss die Hand verlassen, **bevor** der Springer landet
...
1. **Fangen und Werfen in der Luft ohne Kreis:** Anspiel vom Partner, Sprung, Fangen, Wurf aufs leere Tor.
2. **Mit Kreislinie und Markierung:** Absprungzone markieren, Landung im Kreis ohne Ball kontrollieren.
3. **Mit Torwart:** Der Abschluss aus der Luft gegen echten Widerstand – Heber und platzierte Würfe üben.
4. **Mit passiver, dann aktiver Abwehr:** Timing des Einlaufens gegen Verteidiger am Kreis.
5. **Als einstudierter Spielzug:** feste Auslösehandlung (z. B. Kreuzen im Rückraum), klares Zeichen, definierter Flieger.
...
Mit **Statix**, der Handball-Statistik-App für Trainer, erfasst du Tore, Fehlwürfe und technische Fehler live per Tap und siehst schwarz auf weiß, welche Spielzüge Ertrag bringen. So bleibt der Kempa das, was er sein soll: ein kalkuliertes Highlight. Teste es kostenlos und ohne Account in der Live-Demo unter demo.statix-app.de.`,
  faqs: [
    ...
    {
      question: 'Ist der Kempa-Trick regelkonform?',
      answer:
    ...
    {
      question: 'Wie trainiert man den Kempa-Trick?',
      answer:
    ...
    {
      question: 'Wann sollte man den Kempa im Spiel einsetzen?',
      answer:
