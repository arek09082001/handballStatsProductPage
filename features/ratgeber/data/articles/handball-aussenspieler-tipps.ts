...
export const handballAussenspielerTipps: Article = {
  slug: 'handball-aussenspieler-tipps',
  title: 'Außenspieler im Handball: Tipps für spitze Winkel und schnelle Beine',
  metaTitle: 'Außenspieler im Handball: Tipps & Aufgaben',
  metaDescription:
    'Besser auf Außen spielen: Sprungwurf vom Flügel, spitze Winkel überwinden, Tempogegenstoß laufen. Die wichtigsten Tipps für Außenspieler im Handball.',
  keywords: [
    'außenspieler handball',
    'handball außen tipps',
    'flügelspieler handball',
    'spitzer winkel handball',
    'sprungwurf außen handball',
...
| --- | --- |
| Torwart steht an der kurzen Ecke | lange Ecke oder Heber über die Schulter |
| Torwart kommt weit heraus | Heber oder Dreher in die kurze Ecke |
| Torwart bleibt tief stehen | hoch in die lange Ecke oder Aufsetzer |
| Torwart wartet ab | in der Luft „aussteigen" lassen: Wurf antäuschen, dann platzieren |
...
Mit **Statix**, der Handball-Statistik-App für Trainer, wird jeder Wurf mit Position live per Tap erfasst. So siehst du deine Wurfquote von außen, aus dem Gegenstoß und vom Siebenmeterstrich über die ganze Saison – und erkennst genau, woran du arbeiten solltest. Teste es kostenlos und ohne Account in der Live-Demo unter demo.statix-app.de.`,
  faqs: [
    ...
    {
      question: 'Wie wirft man von außen aus spitzem Winkel?',
      answer:
    ...
    {
      question: 'Wie wird man schneller im Tempogegenstoß?',
      answer:
    ...
    {
      question: 'Warum sind Außenspieler oft die Siebenmeterschützen?',
      answer:
