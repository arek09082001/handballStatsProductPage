...
import type { ArticleArchetype } from '../types';
...
export default function ArchetypeBadge({
  ...
  const t = useTranslations('guidePage.archetype');
  ...
  return (
    <span
      className={cn(
        ...
        onDark
          ? 'border-chalk/25 bg-chalk/8 text-chalk/85'
          : 'border-ink/15 bg-paper-2 text-ink/75',
        className,
      )}>
